...
function CharacterTweakData:character_map(...)
	...
	local stripclub_map ={
			"civ_female_stripper_russian_1",
			"civ_female_stripper_russian_2",
			"civ_female_stripper_russian_3",	
			"civ_female_stripper_russian_4",	
			"civ_female_stripper_asian_1",				
			"civ_female_stripper_asian_2",				
			"ene_gang_mobster_5",
			"ene_gang_mobster_6",
			"ene_russian_club_vip_1",
			"ene_russian_club_vip_2",
			"ene_russian_club_owner_1",
	...
	for _, unit in pairs(stripclub_map) do
