Hooks:PostHook(WeaponFactoryTweakData, "init", "TOZ66ModInit", function(self)
local custom_weapon_id = "wpn_fps_shot_toz66"
...
for _, sight_id in pairs(uses_sights) do
	if self.parts[sight_id].stance_mod[stance_base_id] then
		...
		self[custom_weapon_id].adds[sight_id] = {"wpn_fps_shot_toz66_sight_rail"}
	else
