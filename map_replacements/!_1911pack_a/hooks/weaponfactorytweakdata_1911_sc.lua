...
Hooks:PostHook( WeaponFactoryTweakData, "init", "polar9baller_sc_init", function(self)
	...
	if restoration then
		...
		self.parts.wpn_fps_pis_baller_b_standard.supported = true
		self.parts.wpn_fps_pis_baller_b_standard.stats = {}
		self.parts.wpn_fps_pis_baller_b_standard.custom_stats = {}
