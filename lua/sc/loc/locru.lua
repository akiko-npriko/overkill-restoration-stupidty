...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["Overkill-Restoration-StupidtyOptionsButtonTitleID"] = "Настройки Restoration Mod",
		["Overkill-Restoration-StupidtyOptionsButtonDescID"] = "Настройки для Restoration Mod.",
		["Overkill-Restoration-StupidtyHUDOptionsButtonTitleID"] = "Настройки интерфейса Restoration Mod",
		["Overkill-Restoration-StupidtyHUDOptionsButtonDescID"] = "Настройки интерфейса в Restoration Mod.",
		["Overkill-Restoration-StupidtyOTHEROptionsButtonTitleID"] = "Дополнительные настройки Restoration Mod",
		["Overkill-Restoration-StupidtyOTHEROptionsButtonDescID"] = "Дополнительные настройки Restoration Mod.",
		["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonTitleID"] = "+++ Настройки оружия +++",
		["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonDescID"] = "Опции, связанные с оружием.",
		["Overkill-Restoration-StupidtyUIOptionsButtonTitleID"] = "Alpha UI",
		["Overkill-Restoration-StupidtyUIOptionsButtonDescID"] = "Опции Alpha UI.",
		["Overkill-Restoration-StupidtyTimeOfDayTitleID"] = "Новые и случайные времена суток",
		["Overkill-Restoration-StupidtyTimeOfDayDescID"] = "Позволяет настраивать время суток на некоторых ограблениях.",
		["Overkill-Restoration-StupidtyOtherModsTitleID"] = "=== Настройки для других модов ===",
		["Overkill-Restoration-StupidtyOtherModsDescID"] = "Дополнительные настройки для других модов",
		["Overkill-Restoration-StupidtyAdVMovResOptOptionsButtonTitleID"] = "Настройки \"Advanced Movement Standalone\"",
		["Overkill-Restoration-StupidtyAdVMovResOptOptionsButtonDescID"] = "Дополнительные настройки мода \"Advanced Movement Standalone\"  от Solo Queue Pixy's.",
		["Overkill-Restoration-StupidtyDisableAdvMovTFTitleID"] = "Отключить бег и прыжки по стенам",
		["Overkill-Restoration-StupidtyDisableAdvMovTFDescID"] = "Отключает бег и прыжки по стенам, которые являются частью Advanced Movement мода.",
		["Overkill-Restoration-StupidtyAdvMovMeleeTitleID"] = "Оружие ближ. боя",
		["Overkill-Restoration-StupidtyAdvMovMeleeDescID"] = "Меняет поведение оружия ближ. боя от мода Advanced Movement (прыжки/подкаты/рывки/удар с разбега).",
		...
		["Overkill-Restoration-StupidtyEnv_BanksTitleID"] = "Ограбление банка",
		["Overkill-Restoration-StupidtyEnv_BanksDescID"] = "Выбрать погоду для ограбления банка.",
		["Overkill-Restoration-StupidtyEnv_RVD1TitleID"] = "Бешеные псы - день 1",
		["Overkill-Restoration-StupidtyEnv_RVD1DescID"] = "Выбрать погоду для ограбления Бешеные псы (день 1).",
		["Overkill-Restoration-StupidtyEnv_RVD2TitleID"] = "Бешеные псы - день 2",
		["Overkill-Restoration-StupidtyEnv_RVD2DescID"] = "Выбрать погоду для ограбления Бешеные псы (день 2).",
		["Overkill-Restoration-StupidtyEnv_FSD1TitleID"] = "Поджигатель - день 1",
		["Overkill-Restoration-StupidtyEnv_FSD1DescID"] = "Выбрать погоду для ограбления Поджигатель (день 1).",
		["Overkill-Restoration-StupidtyEnv_PBR2TitleID"] = "Рождение небес",
		["Overkill-Restoration-StupidtyEnv_PBR2DescID"] = "Выбрать погоду для ограбления Рождение небес.",
		["Overkill-Restoration-StupidtyEnv_CJ2TitleID"] = "Бомба: Доки",
		["Overkill-Restoration-StupidtyEnv_CJ2DescID"] = "Выбрать погоду для ограбления Бомба: Доки.",
		["Overkill-Restoration-StupidtyEnv_UnderPassTitleID"] = "Транспорт: Проезд",
		["Overkill-Restoration-StupidtyEnv_UnderPassDescID"] = "Выбрать погоду для ограбления Транспорт: Проезд.",
		["Overkill-Restoration-StupidtyEnv_MallCrasherTitleID"] = "Крушитель",
		["Overkill-Restoration-StupidtyEnv_MallCrasherDescID"] = "Выбрать погоду для ограбления Крушитель.",
		["Overkill-Restoration-StupidtyEnv_Mia_1TitleID"] = "Г.Л.Майами - день 1",
		["Overkill-Restoration-StupidtyEnv_Mia_1DescID"] = "Выбрать погоду для ограбления Горячая линия Майами (день 1).",
		["Overkill-Restoration-StupidtyEnv_FSD3TitleID"] = "Поджигатель - день 3",
		["Overkill-Restoration-StupidtyEnv_FSD3DescID"] = "Выбрать погоду для ограбления Поджигатель (день 3).",
		["Overkill-Restoration-StupidtyEnv_WDD1NTitleID"] = "Сторож. псы 1 (Ночь)",
		["Overkill-Restoration-StupidtyEnv_WDD1NDescID"] = "Выбрать погоду для ограбления Сторожевые псы (день 1 - ночной).",
		["Overkill-Restoration-StupidtyEnv_WDD1DTitleID"] = "Сторож. псы 1 (День)",
		["Overkill-Restoration-StupidtyEnv_WDD1DDescID"] = "Выбрать погоду для ограбления Сторожевые псы (день 1 - дневной).",
		["Overkill-Restoration-StupidtyEnv_WDD2DTitleID"] = "Сторож. псы 1 (День))",
		["Overkill-Restoration-StupidtyEnv_WDD2DDescID"] = "Выбрать погоду для ограбления Сторожевые псы (день  - дневной).",
		["Overkill-Restoration-StupidtyEnv_Alex3TitleID"] = "Крысы - день 3",
		["Overkill-Restoration-StupidtyEnv_Alex3DescID"] = "Выбрать погоду для ограбления Крысы (день 3).",
		["Overkill-Restoration-StupidtyEnv_BigTitleID"] = "Большой банк",
		["Overkill-Restoration-StupidtyEnv_BigDescID"] = "Выбрать погоду для ограбления Большой банк.",
		["Overkill-Restoration-StupidtyEnv_FSTitleID"] = "Четыре магазина",
		["Overkill-Restoration-StupidtyEnv_FSDescID"] = "Выбрать погоду для ограбления Четыре магазина.",
		["Overkill-Restoration-StupidtyEnv_UkraTitleID"] = "Украинское дело",
		["Overkill-Restoration-StupidtyEnv_UkraDescID"] = "Выбрать погоду для ограбления Украинское дело.",
		["Overkill-Restoration-StupidtyEnv_KosugiTitleID"] = "Теневой рейд",
		["Overkill-Restoration-StupidtyEnv_KosugiDescID"] = "Выбрать погоду для ограбления Теневой рейд.",
		["Overkill-Restoration-StupidtyEnv_PetaTitleID"] = "Симулятор козы - день 1",
		["Overkill-Restoration-StupidtyEnv_PetaDescID"] = "Выбрать погоду для ограбления Симулятор козы (день 1).",
		["Overkill-Restoration-StupidtyEnv_FRIENDTitleID"] = "Особняк",
		["Overkill-Restoration-StupidtyEnv_FRIENDDescID"] = "Выбрать погоду для ограбления Особняк Лица со шрамом.",
		["Overkill-Restoration-StupidtyINFOHUDOptionsButtonTitleID"] = "Отображение иконок навыков (Buff Tracker)",
		["Overkill-Restoration-StupidtyINFOHUDOptionsButtonDescID"] = "Отображает иконки навыков, которые активны в данный момент, в левом верхнем углу экрана. Не требует включенного Alpha UI.",
		["Overkill-Restoration-StupidtyInfo_HudTitleID"] = "Включить иконки навыков",
		["Overkill-Restoration-StupidtyInfo_HudDescID"] = "Включает или выключает отображение иконок навыков.",
		["Overkill-Restoration-StupidtyInfo_SizeTitleID"] = "Размер иконок",
		["Overkill-Restoration-StupidtyInfo_SizeDescID"] = "Регулирует размер отображаемых иконок навыков.",
		["Overkill-Restoration-StupidtyInfo_CountTitleID"] = "Число рядов",
		["Overkill-Restoration-StupidtyInfo_CountDescID"] = "Регулирует количество рядов иконок навыков, которые будут отображаться, прежде чем добавится новый столбик.",
		["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadTitleID"] = "Агрессивная перезарядка",
		["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_ammo_efficiencyTitleID"] = "Эффективный расход",
		["Overkill-Restoration-StupidtyInfo_ammo_efficiencyDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedTitleID"] = "Кровожадность",
		["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_bullet_stormTitleID"] = "Свинцовый ливень",
		["Overkill-Restoration-StupidtyInfo_bullet_stormDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_revive_damage_reductionTitleID"] = "Анальгин",
		["Overkill-Restoration-StupidtyInfo_revive_damage_reductionDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_desperadoTitleID"] = "Меткий стрелок",
		["Overkill-Restoration-StupidtyInfo_desperadoDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_grinderTitleID"] = "Гистамин (Нападающий)",
		["Overkill-Restoration-StupidtyInfo_grinderDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_infiltratorTitleID"] = "Похититель жизней (Интервент)",
		["Overkill-Restoration-StupidtyInfo_infiltratorDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_sociopathTitleID"] = "Tension и прочее. (Социопат)",
		["Overkill-Restoration-StupidtyInfo_sociopathDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_body_expertiseTitleID"] = "Свинцовый ад",
		["Overkill-Restoration-StupidtyInfo_body_expertiseDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_long_dis_reviveTitleID"] = "Вдохновление",
		["Overkill-Restoration-StupidtyInfo_long_dis_reviveDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_messiahTitleID"] = "Мессия",
		["Overkill-Restoration-StupidtyInfo_messiahDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierTitleID"] = "Overkill",
		["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_revived_damage_reductionTitleID"] = "Колеса",
		["Overkill-Restoration-StupidtyInfo_revived_damage_reductionDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionTitleID"] = "Скорая помощь",
		["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_rogueTitleID"] = "Смертельный инстинкт (Шпион)",
		["Overkill-Restoration-StupidtyInfo_rogueDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_increased_movement_speedTitleID"] = "Бегущий от смерти",
		["Overkill-Restoration-StupidtyInfo_increased_movement_speedDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multTitleID"] = "Крепкий хват",
		["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_trigger_happyTitleID"] = "Неудержимый стрелок",
		["Overkill-Restoration-StupidtyInfo_trigger_happyDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedTitleID"] = "Давление",
		["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_unseen_strikeTitleID"] = "Удар исподтишка",
		["Overkill-Restoration-StupidtyInfo_unseen_strikeDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_survive_one_hitTitleID"] = "Татуировка Они (Якудза)",
		["Overkill-Restoration-StupidtyInfo_survive_one_hitDescID"] = "Включает или выключает отображение иконки данного навыка.",
		["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenTitleID"] = "Лечение от Медицинских сумок",
		["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenDescID"] = "Включает или выключает отображение лечения от Медицинских сумок.",
		["Overkill-Restoration-StupidtyAltLastDownColorTitleID"] = "Другой фильтр для последнего падения",
		["Overkill-Restoration-StupidtyAltLastDownColorDescID"] = "Переключает цветовой фильтр при последнем падении на color_sin_classic.",
		["Overkill-Restoration-StupidtyNoBleedoutTiltTitleID"] = "Отключить наклон камеры при падении",
		["Overkill-Restoration-StupidtyNoBleedoutTiltDescID"] = "Отключает наклон камеры, который происходит после падения.",
		["Overkill-Restoration-StupidtyGOTTAGETAGRIPTitleID"] = "Спрятать все рукоятки",
		["Overkill-Restoration-StupidtyGOTTAGETAGRIPDescID"] = "Прячет все вертикальные рукоятки в меню установки модификаций; не действует на оружие с предустановленной рукоятью. Требуется перезапуск.",
		["Overkill-Restoration-StupidtyADSTransitionStyleTitleID"] = "Стиль прицеливания",
		["Overkill-Restoration-StupidtyADSTransitionStyleDescID"] = "Выбор \"анимации\" прицеливания.",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTitleID"] = "Сурьезный режим",
		["Overkill-Restoration-StupidtyGCGPYPMMSACDescID"] = "Отключает плазменные трассеры и регенерацию патронов от некоторых модулей. Требует перезапуска ограбления.",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTextTitleID"] = "Сурьезный текст",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTextDescID"] = "Выключает все текстовые пасхалки. Требует перезапуска ограбления.",
		["Overkill-Restoration-StupidtyForceEggsOptionsButtonTitleID"] = "",
		["Overkill-Restoration-StupidtyForceEggsOptionsButtonDescID"] = "",
		["Overkill-Restoration-StupidtyUpotteTitleID"] = "",
		["Overkill-Restoration-StupidtyUpotteDescID"] = "",
		["Overkill-Restoration-StupidtyCrabBattleTitleID"] = "",
		["Overkill-Restoration-StupidtyCrabBattleDescID"] = "",
		["Overkill-Restoration-StupidtyEmberMyBelovedTitleID"] = "",
		["Overkill-Restoration-StupidtyEmberMyBelovedDescID"] = "",
		["Overkill-Restoration-StupidtyBigManTitleID"] = "",
		["Overkill-Restoration-StupidtyBigManDescID"] = "",
		["Overkill-Restoration-StupidtyStaticAimTitleID"] = "Покачивание в прицеле",
		["Overkill-Restoration-StupidtyStaticAimDescID"] = "Включает визуальное покачивание во время прицеливания. Требуется перезапуск. ПРИ ОТКЛЮЧЕНИИ, НЕКОТОРУЮ ОПТИКУ БУДЕТ НЕВОЗМОЖНО ИСПОЛЬЗОВАТЬ.",
		["Overkill-Restoration-StupidtyViewmodelMovementTitleID"] = "Движение вьювмоделей",
		["Overkill-Restoration-StupidtyViewmodelMovementDescID"] = "Стиль движения моделей оружия при кручении камеры. Требует перезапуск.",
		["vm_vanilla"] = "Ванильное",
		["vm_drag"] = "Оружие отстает",
		["vm_lead"] = "Оружие опережает",
		["vm_static"] = "Без движения",
		["Overkill-Restoration-StupidtyCarpalTunnelTitleID"] = "Компенсация отдачи",
		["Overkill-Restoration-StupidtyCarpalTunnelDescID"] = "Оружие возвращается в изначальное положение, как в ванильной игре.",
		["rr_off"] = "Нет",
		["rr_per_weapon"] = "Частичная",
		["rr_full"] = "Полная",
		["Overkill-Restoration-StupidtyWpnCatTitleID"] = "Сортировка меню оружия",
		["Overkill-Restoration-StupidtyWpnCatDescID"] = "Изменить порядок оружия в меню покупки. Требуется перезапуск.",
		["Overkill-Restoration-StupidtyAutoDMRsTitleID"] = "Авто. марксманские винтовки",
		["Overkill-Restoration-StupidtyAutoDMRsDescID"] = "Марксманские винтовки будут сразу установлены в автоматический режим.",
		["Overkill-Restoration-StupidtyWpnFireDescopeTitleID"] = "Выход из прицеливания для некоторых оружий",
		["Overkill-Restoration-StupidtyWpnFireDescopeDescID"] = "Позволяет временно выйти из режима прицеливания во время стрельбы, чтобы не было ситуаций, когда руки во время анимации проходили через камеру игрока.\nНе работает для оружий, у которых в описании написано про выход из режима прицеливания.",
		["Overkill-Restoration-StupidtySprintCancelTitleID"] = "'Изворотливый' отменяет перезарядку",
		["Overkill-Restoration-StupidtySprintCancelDescID"] = "Пиковый навык \"Изворотливый\" отменит перезарядку при начале бега. Перезарядка во время бега не отменяется.",
		["Overkill-Restoration-StupidtySevenHoldTitleID"] = "Липкие интеракции (Press2Hold)",
		["Overkill-Restoration-StupidtySevenHoldDescID"] = "Для интеракций больше не требуется держать клавишу.",
		["Overkill-Restoration-StupidtySevenHoldDeployCancelTitleID"] = "Снаряжение отменяет интеракцию",
		["Overkill-Restoration-StupidtySevenHoldDeployCancelDescID"] = "Кнопка снаряжения будет отменять текущую интеракцию. Требует включения Липких интеракций.",
		["Overkill-Restoration-StupidtyQueuedShootingTitleID"] = "Очередь нажатий",
		["Overkill-Restoration-StupidtyQueuedShootingDescID"] = "Включить/выключить занос нажатия на курок в очередь для полуавтоматического оружия.\nПри использовании этой функции выключает оригинальную (ванильную) версию этой настройки.",
		["Overkill-Restoration-StupidtyQueuedShootingWindowTitleID"] = "Чувствительность очереди",
		["Overkill-Restoration-StupidtyQueuedShootingWindowDescID"] = "Время, которое ваши нажатия будут в очереди, в зависимости от задержки оружия. Чем выше, тем раньше нажатия попадут в очередь.",
		...
		["Overkill-Restoration-StupidtyQueuedShootingExcludeTitleID"] = "Ограничение очереди",
		["Overkill-Restoration-StupidtyQueuedShootingExcludeDescID"] = "Ограничивает очередь для оружия, которое стреляет быстрее, чем указано в этой настройке.",
		["Overkill-Restoration-StupidtyQueuedShootingMidBurstTitleID"] = "Очередь нажатий во время стрельбы оружейной очередью",
		["Overkill-Restoration-StupidtyQueuedShootingMidBurstDescID"] = "Заносит нажатия на курок в очередь, если они были сделаны во время стрельбы оружейной очередью.",
		["Overkill-Restoration-StupidtyQueuedShootingBurstExcludeTitleID"] = "Ограничение для стрельбы очередями",
		["Overkill-Restoration-StupidtyQueuedShootingBurstExcludeDescID"] = "Ограничивает занесение нажатий в очередь, сделанных во время стрельбы очередью из огнестрела, для тех оружий, задержка которых ниже, чем выставленная этой настройкой.",
		["Overkill-Restoration-StupidtyNoADSRecoilAnimsTitleID"] = "Отключить отдачу в прицеле",
		["Overkill-Restoration-StupidtyNoADSRecoilAnimsDescID"] = "Отключает анимацию отдачи во время прицеливания. Опция не влияет на некоторое оружие (луки, огнеметы)",
		["Overkill-Restoration-StupidtyNoSwapOnReviveTitleID"] = "Отключить переключение оружия после поднятия",
		["Overkill-Restoration-StupidtyNoSwapOnReviveDescID"] = "Когда вас поднимут, оружие больше не будет переключаться с вторичного на основное.",
		["Overkill-Restoration-StupidtyManualReloadsTitleID"] = "Перезарядка вручную",
		["Overkill-Restoration-StupidtyManualReloadsDescID"] = "Выключает автоматическую перезарядку, когда магазин оружия пуст.",
		["Overkill-Restoration-StupidtySecondSightSprintTitleID"] = "Кнопка спринта включает второй прицел",
		["Overkill-Restoration-StupidtySecondSightSprintDescID"] = "Переключаться между прицелами с помощью кнопки спринта, а не гаджета. С этой настройкой нельзя использовать спринт во время прицеливания, а кнопка гаджета будет включать и выключать гаджеты даже во время прицеливания.",
		["Overkill-Restoration-StupidtyAimDeploysBipodTitleID"] = "Прицеливание с сошками",
		["Overkill-Restoration-StupidtyAimDeploysBipodDescID"] = "Кнопка прицеливания развернет сошки, если имеется такая возможность.",
		["Overkill-Restoration-StupidtyMoveCancelBipodTitleID"] = "Движение убирает сошки",
		["Overkill-Restoration-StupidtyMoveCancelBipodDescID"] = "Клавиши движения развернут сошки.",
		["Overkill-Restoration-StupidtySeparateBowADSTitleID"] = "Прицеливание луков",
		["Overkill-Restoration-StupidtySeparateBowADSDescID"] = "Отключает автоматическое прицеливание при стрельбе из лука. Клавиша перезарядки опускает заряженную стрелу.",
		["Overkill-Restoration-StupidtyPerPelletShotgunsTitleID"] = "Урон от дробовика за каждую дробинку (WIP)",
		["Overkill-Restoration-StupidtyPerPelletShotgunsDescID"] = "Урон от дробовика рассчитывается за каждую дробинку в отличие от стандартного \"1 дробинка = полный урон, приоритет отдается выстрелам в голову\". Урон от дробовика, наносимый обычной дробью, увеличен, чтобы компенсировать потерю урона при промахе дробинками. Требуется перезагрузка.",
		["Overkill-Restoration-StupidtyClassicMoviesTitleID"] = "Классический фон подготовки",
		["Overkill-Restoration-StupidtyClassicMoviesDescID"] = "Включить или выключить фон экрана подготовки из PD:TH при игре на Классических ограблениях.",
		...
		["Overkill-Restoration-StupidtyWepNamesTitleID"] = "Названия оружия",
		["Overkill-Restoration-StupidtyWepNamesDescID"] = "Стиль названия оружия и модулей. Требуется перезапуск.",
		...
		["Overkill-Restoration-StupidtyPaintingsTitleID"] = "Вырезанные картины в Картинной галерее",
		["Overkill-Restoration-StupidtyPaintingsDescID"] = "Включает или выключает отображение вырезанных картин на ограблении “Картинная галерея”. Работает только для хоста.",
		["Overkill-Restoration-StupidtyMainHUDTitleID"] = "Alpha HUD - ВКЛ/ВЫКЛ",
		["Overkill-Restoration-StupidtyMainHUDDescID"] = "Полностью включает или выключает интерфейс из альфа-версии игры.",
		["Overkill-Restoration-StupidtyWaypointsTitleID"] = "Иконки целей из Альфы",
		["Overkill-Restoration-StupidtyWaypointsDescID"] = "Включить или выключить иконки, указывающие на текущую цель из альфа-версии игры.",
		["Overkill-Restoration-StupidtyAssaultPanelTitleID"] = "Лента штурма из Альфы",
		["Overkill-Restoration-StupidtyAssaultPanelDescID"] = "Включить или выключить ленту штурма из альфа-версии игры.",
		["Overkill-Restoration-StupidtyAltAssaultTitleID"] = "Индикатор штурма из ранней Альфы",
		["Overkill-Restoration-StupidtyAltAssaultDescID"] = "Включить или выключить индикатор штурма из ранней альфа-версии игры. Заменяет ленту штурма.",
		["Overkill-Restoration-StupidtyObjectivesPanelTitleID"] = "Панель задач из Альфы",
		["Overkill-Restoration-StupidtyObjectivesPanelDescID"] = "Включить или выключить панель задач из альфа-версии игры.",
		["Overkill-Restoration-StupidtyPresenterTitleID"] = "Презентер из Альфы",
		["Overkill-Restoration-StupidtyPresenterDescID"] = "Включить или выключить презентер из альфа-версии игры, который используется при захвате добычи и для напоминания о задачах.",
		["Overkill-Restoration-StupidtyInteractionTitleID"] = "Шкала интеракции из Альфы",
		["Overkill-Restoration-StupidtyInteractionDescID"] = "Включить или выключить шкалу интеракции из альфа-версии игры.",
		["Overkill-Restoration-StupidtyStealthTitleID"] = "Индикатор скрытности из Альфы",
		["Overkill-Restoration-StupidtyStealthDescID"] = "Включить или выключить индикатор скрытности из Альфы. Используется при стелсе.",
		["Overkill-Restoration-StupidtyDownTitleID"] = "Таймер падения из Альфы",
		["Overkill-Restoration-StupidtyDownDescID"] = "Включить или выключить таймер падения из альфа-версии игры.",
		["Overkill-Restoration-StupidtyBagTitleID"] = "Панель сумок из Альфы",
		["Overkill-Restoration-StupidtyBagDescID"] = "Включить или выключить панель сумок из альфа-версии игры.",
		["Overkill-Restoration-StupidtyHostageTitleID"] = "Прятать панель заложников",
		["Overkill-Restoration-StupidtyHostageDescID"] = "Если включен, прячет панель заложников когда начинается штурм, при условии, что лента или индикатор штурма из Альфы включены.",
		["Overkill-Restoration-StupidtyDifficultyMarkersTitleID"] = "Иконки сложностей из пре-релиза",
		["Overkill-Restoration-StupidtyDifficultyMarkersDescID"] = "Включить или выключить иконки сложностей из пре-релиза игры.",
		["Overkill-Restoration-StupidtyStaminaIndicatorTitleID"] = "Дебаговая полоска выносливости",
		["Overkill-Restoration-StupidtyStaminaIndicatorDescID"] = "Включить или выключить дебаговую полоску выносливости.",
		["Overkill-Restoration-StupidtyBlackScreenTitleID"] = "Начало ограбления из Restoration",
		["Overkill-Restoration-StupidtyBlackScreenDescID"] = "Включить или выключить начальную заставку ограблений из Restoration.",
		["Overkill-Restoration-StupidtyLoadoutsTitleID"] = "Меню подготовки из Альфы",
		["Overkill-Restoration-StupidtyLoadoutsDescID"] = "Включить или выключить меню подготовки из альфа-версии игры.",
		["Overkill-Restoration-StupidtyDistrictTitleID"] = "Описания районов в CRIME.NET",
		["Overkill-Restoration-StupidtyDistrictDescID"] = "Включить или выключить описания районов в CRIME.NET. Описания не соответствуют геймплею.",
		["Overkill-Restoration-StupidtySCOptionsButtonTitleID"] = "Опции Restoration Overhaul",
		["Overkill-Restoration-StupidtySCOptionsButtonDescID"] = "Опции Restoration Overhaul",
		...
		["Overkill-Restoration-StupidtyBotsNoDropTitleID"] = "Отключить сброс сумок у ботов",
		["Overkill-Restoration-StupidtyBotsNoDropDescID"] = "Боты больше не будут сбрасывать мешки.",
		["Overkill-Restoration-StupidtyCloakerTurnTitleID"] = "Пинок Клокера: Поворачивать камеру",
		["Overkill-Restoration-StupidtyCloakerTurnDescID"] = "Камера будет поворачиваться на Клокера, когда он вас пинает, как в ванилле.",
		["Overkill-Restoration-StupidtyDisableMutatorColorsTitleID"] = "Выключить смену цвета баннера штурма",
		["Overkill-Restoration-StupidtyDisableMutatorColorsDescID"] = "Выключает смену цвета баннера штурма, вызванное использованием мутаторов (работает только с обычным баннером).",
		...
		["Overkill-Restoration-StupidtyHolidayTitleID"] = "Праздничные эффекты",
		["Overkill-Restoration-StupidtyHolidayDescID"] = "Включает или выключает праздничные эффекты в моде.",
		["Overkill-Restoration-StupidtyRestoreHitFlashTitleID"] = "Вспышка при уроне",
		["Overkill-Restoration-StupidtyRestoreHitFlashDescID"] = "Включить или выключить вспышку экрана при получении урона из старых версий игры.",
		["Overkill-Restoration-StupidtyNotifyTitleID"] = "Уведомление",
		["Overkill-Restoration-StupidtyNotifyDescID"] = "Включить или выключить уведомления мода.",
		["Overkill-Restoration-StupidtyPauseTitleID"] = "Меню паузы из Альфы",
		["Overkill-Restoration-StupidtyPauseDescID"] = "Включить или выключить меню паузы из альфа-версии игры.",
		...
		["Overkill-Restoration-StupidtyColorOption"] = "Изменить цвет элемента интерфейса",
		["Overkill-Restoration-StupidtyColorsOptionsButtonTitleID"] = "Настройки цветов",
		["Overkill-Restoration-StupidtyColorsOptionsButtonDescID"] = "Изменить цвет различных элементов интерфейса.",
		["Overkill-Restoration-StupidtyObjectivesBGTitleID"] = "Задачи - задний план",
		["Overkill-Restoration-StupidtyObjectivesFGTitleID"] = "Задачи - передний план",
		["Overkill-Restoration-StupidtyAssaultBGTitleID"] = "Штурм - задний план",
		["Overkill-Restoration-StupidtyAssaultFGTitleID"] = "Штурм - передний план",
		["Overkill-Restoration-StupidtyNoReturnTitleID"] = "Текст Точки невозврата",
		["Overkill-Restoration-StupidtyTimerTextTitleID"] = "Таймер (время) ограбления",
		["Overkill-Restoration-StupidtyAssaultEndlessBGTitleID"] = "Штурм капитана",
		["Overkill-Restoration-StupidtyAssaultSurvivedBGTitleID"] = "Пережитый штурм",
		["Overkill-Restoration-StupidtyStaminaTitleID"] = "Выносливость",
		["Overkill-Restoration-StupidtyStaminaThresholdTitleID"] = "Порог выносливости",
		["Overkill-Restoration-StupidtyBagBitmapTitleID"] = "Сумка",
		["Overkill-Restoration-StupidtyBagTextTitleID"] = "Текст сумок",
		["Overkill-Restoration-StupidtyNoReturnTextTitleID"] = "Текст Точки невозврата",
		["Overkill-Restoration-StupidtyHostagesTextTitleID"] = "Текст заложников",
		["Overkill-Restoration-StupidtyHintTextTitleID"] = "Текст подсказок",
		["Overkill-Restoration-StupidtyMaskOnTextTitleID"] = "Текст надевания маски",
		["Overkill-Restoration-StupidtyDownsThreePlusTitleID"] = "Счетчик падений (при 3+ падений)",
		["Overkill-Restoration-StupidtyDownsTwoTitleID"] = "Счетчик падений (при 2 падениях)",
		["Overkill-Restoration-StupidtyDownsOneTitleID"] = "Счетчик падений (при 1 падении)",
		["Overkill-Restoration-StupidtyDownsZeroTitleID"] = "Счетчик падений (при 0 падений)",
		["Overkill-Restoration-StupidtyStopAllBotsTitleID"] = "Останавливать всех ботов",
		["Overkill-Restoration-StupidtyStopAllBotsDescID"] = "Останавливать всех ботов, если удержана кнопка остановки бота.",
		["Overkill-Restoration-StupidtyPONRTrackTitleID"] = "Музыка во время Точки невозврата",
		["Overkill-Restoration-StupidtyPONRTrackDescID"] = "Изменяет музыку во время Точки невозврата в режиме Pro-Job.",
		["Overkill-Restoration-StupidtyPONRTracksTitleID"] = "Музыка во время Точки невозврата",
		["Overkill-Restoration-StupidtyPONRTracksDescID"] = "Выберите музыку, которая начнется во время Точки невозврата в режиме Pro-Job.",
		["Overkill-Restoration-StupidtyMusicShuffleTitleID"] = "Перемешка музыки",
		["Overkill-Restoration-StupidtyMusicShuffleDescID"] = "Музыка будет меняться после конца каждого штурма.",
		...
		["Overkill-Restoration-StupidtyScaleTitleID"] = "Размер интерфейса",
		["Overkill-Restoration-StupidtyScaleDescID"] = "Изменяет размер интерфейса. Может потребоваться перезапуск игры.",
		["Overkill-Restoration-StupidtySizeOnScreenTitleID"] = "Размер интерфейса на экране",
		["Overkill-Restoration-StupidtySizeOnScreenDescID"] = "Изменяет размер интерфейса на экране. Может потребоваться перезапуск игры.",
		["Overkill-Restoration-StupidtyTeammateTitleID"] = "Панель команды из Альфы",
		["Overkill-Restoration-StupidtyTeammateDescID"] = "Включает или выключает панель команды из альфа-версии игры, которая отображает статистику вас и вашей команды.",
		["Overkill-Restoration-StupidtyHeistTimerTitleID"] = "Время ограбления из Альфы",
		["Overkill-Restoration-StupidtyHeistTimerDescID"] = "Включает или выключает время (таймер) ограбления из альфа-версии игры.",
		["Overkill-Restoration-StupidtyMaskOnTitleID"] = "Текст надевания маски из Альфы",
		["Overkill-Restoration-StupidtyMaskOnDescID"] = "Включает или выключает текст надевания маски из альфа-версии игры.",
		["Overkill-Restoration-StupidtyNameLabelsTitleID"] = "Ники игроков из Альфы",
		["Overkill-Restoration-StupidtyNameLabelsDescID"] = "Включить или выключить ники игроков из альфа-версии игры.",
		["Overkill-Restoration-StupidtyHintTitleID"] = "Панель подсказок из Альфы",
		["Overkill-Restoration-StupidtyHintDescID"] = "Включить или выключит панель подсказок из альфа-версии игры.",
		["Overkill-Restoration-StupidtyExtraOptionsButtonTitleID"] = "Дополнительные опции интерфейса",
		["Overkill-Restoration-StupidtyExtraOptionsButtonDescID"] = "Еще больше опций!",
		["Overkill-Restoration-StupidtyRealAmmoTitleID"] = "Действительный счетчик патронов",
		["Overkill-Restoration-StupidtyRealAmmoDescID"] = "Счетчик патронов в запасе будет игнорировать патроны, которые уже заряжены.",
		["Overkill-Restoration-StupidtyStealthOrigPosTitleID"] = "Стандартное расположение обнаружения",
		["Overkill-Restoration-StupidtyStealthOrigPosDescID"] = "Полоска обнаружения будет в том же месте, что и в ванильной игре.",
		["Overkill-Restoration-StupidtyLowerBagTitleID"] = "Понизить текст о подобранной сумке",
		["Overkill-Restoration-StupidtyLowerBagDescID"] = "Текст, который появляется, если подобрать сумку, будет расположен ниже.",
		["Overkill-Restoration-StupidtyAssaultStyleTitleID"] = "Стиль панели штурма",
		["Overkill-Restoration-StupidtyAssaultStyleDescID"] = "Позволяет выбрать стиль панели штурма.",
		["Overkill-Restoration-StupidtyCasingTickerTitleID"] = "Лента исследования из Альфы",
		["Overkill-Restoration-StupidtyCasingTickerDescID"] = "Включить или выключить ленту режима исследования из альфа-версии игры (Требует включенную ленту из Альфы).",
		["Overkill-Restoration-StupidtyCustodyTitleID"] = "Панель заключения под стражу из Альфы",
		["Overkill-Restoration-StupidtyCustodyDescID"] = "Включить или выключить панель заключения под стражу из альфа-версии игры.",
		["Overkill-Restoration-StupidtyCrimenetTitleID"] = "CRIMENET из Альфы",
		["Overkill-Restoration-StupidtyCrimenetDescID"] = "Включает или выключает CRIMENET из альфа-версии игры.",
		["Overkill-Restoration-StupidtyProfileTitleID"] = "Окно с профилями из Альфы",
		["Overkill-Restoration-StupidtyProfileDescID"] = "Включить или выключить окно с профилями из альфа-версии игры.",
		["Overkill-Restoration-StupidtyNewsfeedTitleID"] = "Лента новостей из Альфы",
		["Overkill-Restoration-StupidtyNewsfeedDescID"] = "Включить или выключить ленту новостей из альфа-версии игры.",
		["Overkill-Restoration-StupidtyUppercaseNamesTitleID"] = "Ники заглавными буквами",
		["Overkill-Restoration-StupidtyUppercaseNamesDescID"] = "Включить или выключить отображение ников игроков заглавными буквами.",
		["Overkill-Restoration-StupidtyPeerColorsTitleID"] = "Цвета товарищей из Альфы",
		["Overkill-Restoration-StupidtyPeerColorsDescID"] = "Включить или выключить цвета товарищей из альфа-версии игры.",
		["Overkill-Restoration-StupidtyPocoCrimenetAlignSortTitleID"] = "Подгонка и сортировка CRIMENET",
		["Overkill-Restoration-StupidtyPocoCrimenetAlignSortDescID"] = "Подгоняет и сортирует CRIMENET по сложности.",
		["Overkill-Restoration-StupidtyPocoCrimenetScaleTitleID"] = "Масштаб CRIMENET",
		["Overkill-Restoration-StupidtyPocoCrimenetScaleDescID"] = "Позволяет менять масштаб CRIMENET.",
		...
		["Overkill-Restoration-StupidtyVoiceIconTitleID"] = "Голосовой чат",
		["Overkill-Restoration-StupidtyVoiceIconDescID"] = "Отображает иконку, когда игрок использует голосовой чат.",
		...
		["Overkill-Restoration-StupidtyDodgeDisplayTitleID"] = "Цифра шкалы уворота",
		["Overkill-Restoration-StupidtyDodgeDisplayDescID"] = "Максимальное число, которое *отображает* шкала уворота. Требует перезапуска.",
		...
		["Overkill-Restoration-StupidtyPDTHChallengesTitleID"] = "Отображать испытания из PDTH",
		["Overkill-Restoration-StupidtyPDTHChallengesDescID"] = "Включает отображение испытаний из PDTH в меню и на HUD.",
		...
		["Overkill-Restoration-StupidtyArmorFixTitleID"] = "Фикс подсвечивания брони",
		["Overkill-Restoration-StupidtyArmorFixDescID"] = "Включить или выключить фикс подсвечивания брони.",
