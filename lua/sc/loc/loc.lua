	...
	--[[   SKILLTREES   ]]--
		...
		--[[   MASTERMIND   ]]--
			...
			--[[   ASSAULT SUBTREE   ]]--
				...
				["menu_spotter_teamwork_beta_desc_sc"] = "BASIC: #{owned}#$basic##\n#{skill_color}#Most weapon## magazine sizes are increased by #{skill_color}#$skill_value_b1.##\n\n#{risk}#NOTE: Does not apply to## #{important_1}#bows, launchers, some tubular-based guns or single-round guns.##\n\nACE: #{owned}#$pro##\nThe magazine size increase is raised by an additional #{skill_color}#$skill_value_p1.##\n\n#{skill_color}#Some tubular-based guns## deal #{skill_color}#20%## more damage.\n#{skill_color}#Single-round guns## deal #{skill_color}#25%## more damage.\n\n#{skill_color}#All weapons## can be hipfired while sprinting and their sprint-to-fire delay is removed.\n\n#{risk}#NOTE: Damage bonuses are not stackable.##",
...
menu_risk_sm_wish = "For the masters of PAYDAY, the weak will be destroyed."
	...
	LocalizationManager:add_localized_strings({
	hoplib_owners_unit = "$OWNER's $UNIT",
	civ_female_bank_manager = "Bank Manager",
	civ_female = "Civilian",
	civ_male_bain = "Bain",
	civ_male_bank_manager = "Bank Manager",
	civ_male_locke_escort = "Vernon Locke",
	civ_male_mitch = "Mitchell",
	civ_male_taxman = "Taxman",
	civ_male_vlad = "Vlad",
	civ_male = "Civilian",
	ene_akan_cs_cop = "Mercenary",
	ene_akan_cs_heavy = "Mercenary Heavy",
	ene_akan_cs_shield = "Shield",
	ene_akan_cs_swat_sniper = "Sniper",
	ene_akan_cs_swat = "Mercenary Light",
	ene_akan_cs_tazer = "Taser",
	ene_akan_fbi_heavy = "Mercenary Heavy",
	ene_akan_fbi_shield_dw = "Shield",
	ene_akan_fbi_shield = "Shield",
	ene_akan_fbi_spooc = "Cloaker",
	ene_akan_fbi_swat_dw = "Mercenary Light",
	ene_akan_fbi_swat = "Mercenary Light",
	ene_akan_fbi_tank_r870 = "Bulldozer",
	ene_akan_fbi_tank_rpk_lmg = "Skulldozer",
	ene_akan_fbi_tank_saiga = "Blackdozer",
	ene_akan_medic = "Medic",
	ene_bex_security_suit = "Security Guard",
	ene_bex_security = "Security Guard",
	ene_biker_female = "Biker",
	ene_biker = "Biker",
	ene_bolivian_thug_outdoor = "Bolivian",
	ene_bulldozer_1 = "Bulldozer",
	ene_bulldozer_2 = "Blackdozer",
	ene_bulldozer_3 = "Skulldozer",
	ene_bulldozer_4 = "Headless Titandozer",
	ene_bulldozer_medic = "Medicdozer",
	ene_bulldozer_minigun_classic = "Minigundozer",
	ene_bulldozer_minigun = "Minigundozer",
	ene_captain = "Captain",
	ene_city_heavy = "GenSec Heavy SWAT",
	ene_city_shield = "Shield",
	ene_city_swat = "GenSec SWAT",
	ene_cop_female = "Cop",
	ene_cop = "Cop",
	ene_drug_lord_boss_stealth = "Ernesto Sosa",
	ene_drug_lord_boss = "Ernesto Sosa",
	ene_deep_security = "Security Guard",
	ene_fbi_boss = "FBI Agent",
	ene_fbi_female = "FBI Agent",
	ene_fbi_heavy = "FBI Heavy SWAT",
	ene_fbi_office = "FBI Agent",
	ene_fbi_swat = "FBI SWAT",
	ene_fbi = "FBI Agent",
	ene_female_civ_undercover = "Undercover Agent",
	ene_female_crew = "Crew Member",
	ene_female_office_cop = "Office Cop",
	ene_gabriel = "Gabriel Santiago",
	ene_gabriel_nomask = "Gabriel Santiago",
	ene_gang_biker_boss = "Biker Boss",
	ene_gang_black = "Gangster",
	ene_gang_hispanic = "Gangster",
	ene_gang_mexican = "Gangster",
	ene_gang_mobster_boss = "The Commissar",
	ene_gang_mobster = "Mobster",
	ene_gang_russian = "Gangster",
	ene_guard_dog_mask_no_pager = "Guard",
	ene_guard_dog_mask = "Guard",
	ene_guard_jaguar_mask_no_pager = "Guard",
	ene_guard_jaguar_mask = "Guard",
	ene_guard_national = "National Guard",
	ene_guard_owl_mask_no_pager = "Guard",
	ene_guard_owl_mask = "Guard",
	ene_guard_security_heavy = "Security Guard",
	ene_guard_serpent_mask_no_pager = "Guard",
	ene_guard_serpent_mask = "Guard",
	ene_hoxton_breakout_guard = "FBI Safe House Guard",
	ene_la_cop = "Cop",
	ene_locke = "Vernon Locke",
	ene_male_bain = "Bain",
	ene_male_chas_police = "Cop",
	ene_male_commissioner = "Commissioner Garrett",
	ene_male_crew = "Crew Member",
	ene_male_hector = "Hector Morales",
	ene_male_marshal_marksman = "Marshal Marksman",
	ene_male_marshal_shield = "Marshal Shield",
	ene_male_office_cop = "Cop",
	ene_male_ranc_ranger = "Texas Ranger",
	ene_male_ranc_security = "Security Guard",
	ene_male_ranchmanager = "Esteban Santiago",
	ene_male_security_penthouse = "Security Guard",
	ene_male_triad_gang = "Triad Member",
	ene_male_triad_penthouse = "Triad Member",
	ene_male_triad = "Triad Member",
	ene_medic = "Medic",
	ene_mex_security_guard = "Security Guard",
	ene_mex_thug_outdoor = "Thug",
	ene_murkywater_bulldozer_1 = "Minigundozer",
	ene_murkywater_bulldozer_2 = "Bulldozer",
	ene_murkywater_bulldozer_3 = "Blackdozer",
	ene_murkywater_bulldozer_4 = "Skulldozer",
	ene_murkywater_bulldozer_medic = "Medicdozer",
	ene_murkywater_cloaker = "Cloaker",
	ene_murkywater_heavy_shotgun = "Murkywater Heavy",
	ene_murkywater_heavy = "Murkywater Heavy",
	ene_murkywater_light_city = "Murkywater Light",
	ene_murkywater_light_fbi = "Murkywater Light",
	ene_murkywater_light = "Murkywater Light",
	ene_murkywater_medic = "Medic",
	ene_murkywater_no_light_not_security = "Murkywater",
	ene_murkywater_no_light = "Murkywater",
	ene_murkywater_not_security = "Murkywater",
	ene_murkywater_secret_service = "Murkywater Secret Service",
	ene_murkywater_shield = "Shield",
	ene_murkywater_sniper = "Sniper",
	ene_murkywater_tazer = "Taser",
	ene_murkywater = "Murkywater",
	ene_phalanx = "Winters Shield",
	ene_policia = "Cop",
	ene_prisonguard_female = "Prison Guard",
	ene_prisonguard_male = "Prison Guard",
	ene_secret_service_1_casino = "Secret Service Agent",
	ene_secret_service_fex = "Secret Service Agent",
	ene_secret_service = "Secret Service Agent",
	ene_security_cruise = "Security Guard",
	ene_security_gensec = "GenSec Security Guard",
	ene_security_manager = "Security Manager",
	ene_security = "Security Guard",
	ene_shadow_cloaker = "Shadow Cloaker",
	ene_shield = "Shield",
	ene_sniper = "Sniper",
	ene_spook = "Cloaker",
	ene_swat_cloaker_policia_federale = "Cloaker",
	ene_swat_dozer_medic_policia_federale = "Medicdozer",
	ene_swat_dozer_policia_federale_m249 = "Skulldozer",
	ene_swat_dozer_policia_federale_minigun = "Minigundozer",
	ene_swat_dozer_policia_federale_r870 = "Bulldozer",
	ene_swat_dozer_policia_federale_saiga = "Blackdozer",
	ene_swat_heavy_policia_federale_fbi = "Federal Police Heavy",
	ene_swat_heavy_policia_federale = "Federal Police Heavy",
	ene_swat_heavy = "Heavy SWAT",
	ene_swat_medic_policia_federale = "Medic",
	ene_swat_policia_federale_city_fbi = "Federal Police",
	ene_swat_policia_federale_city = "Federal Police",
	ene_swat_policia_federale_fbi = "Federal Police",
	ene_swat_policia_federale = "Federal Police",
	ene_swat_policia_sniper = "Sniper",
	ene_swat_shield_policia_federale = "Shield",
	ene_swat_tazer_policia_federale = "Taser",
	ene_swat = "SWAT",
	ene_tazer = "Taser",
	ene_thug_indoor = "Bolivian",
	ene_thug_outdoor_fex = "Thug",
	ene_triad_cruise = "Triad Member",
	ene_vip = "Captain Winters",
	ene_zeal_bulldozer_2 = "National Guard Bulldozer",
	ene_zeal_bulldozer_3 = "National Guard Blackdozer",
	...
	ene_zeal_tazer = "XOF Volunteer",
	npc_chavez = "Chavez",
	npc_cop = "Cop",
	npc_jamaican = "Jamaican",
	npc_locke = "Vernon Locke",
	npc_male_cfo = "CFO",
	npc_male_mechanic = "Mechanic",
	npc_male_ralph = "Ralph Garnet",
	npc_male_vladbroinlaw_cop_pex = "Hajrudin",
	npc_male_vladbroinlaw_pex_bloody = "Hajrudin",
	npc_male_vladbroinlaw_pex = "Hajrudin",
	npc_male_yufuwang_armored = "Yufu Wang",
	npc_male_yufuwang = "Yufu Wang",
	npc_matt = "Matt Roscoe",
	npc_mr_blonde = "Mr. Blonde",
	npc_mr_brown_civ = "Mr. Brown",
	npc_mr_brown = "Mr. Brown",
	npc_mr_orange = "Mr. Orange",
	npc_mr_pink_escort = "Mr. Pink",
	npc_mr_pink = "Mr. Pink",
	npc_old_hoxton_prisonsuit = "Hoxton",
	npc_prisoner = "Prisoner",
	npc_sophia = "Sophia",
	npc_spa = "Charon",
	npc_vlad = "Vlad",
	npc_yakuza_prisoner = "Kazuo",
	tweak_aa_turret_module = "Anti-Aircraft Turret",
	tweak_ceiling_turret_module = "Ceiling Turret",
	tweak_crate_turret_module = "Crate Turret",
	tweak_swat_van_turret_module = "SWAT Turret",
	ene_mememan_1 = "MEME MAN: THE AKIMBO MINIGUNNER",
  ene_mememan_2 = "MEME MAN 2 ELECTRIC BOOGALOO: THE OVERPOWERED SHIELD MAN",
  ene_big_dave = "MI6 Elite Soldier",
  ene_veteran_lod = "EPIC JONATHAN MACCLANE",
  ene_gensec_heavygunner = "GenSec HeavyGunner Elite Leader Squad",
  ene_heavymedic_1 = "Emergency Paramedic Heavy",
  ene_fbi = "HRT",
  ene_fbi_boss = "Agent Riker",   
  ene_nypd_murky = "Murkywater Elite Security",
  ene_murkywater = "Murkywater Flight Crew",
  ene_murkywater_no_light_not_security = "Murkywater Flight Crew",
  ene_murkywater_no_light = "Murkywater Flight Crew", 
  ene_spook_cloak = "OMNIA Titan Cloaker",  
  ene_veteran_cop = "Jonathan Macclane",    
  ene_bulldozer_2_hw = "Headless Blackdozer",
  ene_bulldozer_4_minion = "Headless Titandozer",  
  ene_bulldozer_medic = "Medicdozer",
  ene_bulldozer_medic_sc = "Medicdozer",
  ene_bulldozer_medic_classic = "Medicdozer",  
  ene_bulldozer_minigun = "Benellidozer",
  ene_bulldozer_minigun_classic = "Benellidozer",
  ene_bravo_bulldozer = "National Guard Benellidozer",
  ene_city_heavy_r870_sc = "GenSec Heavy SWAT",  
  ene_city_heavy_g36_sc = "GenSec Heavy SWAT",
  ene_security_gensec_guard = "GenSec Security Guard",
  ene_shield_gensec = "GenSec Shield",  
  ene_city_swat_1_sc = "GenSec SWAT",  
  ene_city_swat_2_sc = "GenSec SWAT",  
  ene_city_swat_3_sc = "GenSec SWAT",  
  ene_grenadier = "Grenadier", 
  ene_cop_1_forest = "Cop",
  ene_cop_2_forest = "Cop",    
  ene_bulldozer_1_sc = "Bulldozer",
  ene_bulldozer_1_hard = "Bulldozer",
  ene_bulldozer_2_sc = "Blackdozer",
  ene_bulldozer_3_sc = "GenSec Skulldozer",
  ene_swat_heavy_1_sc = "Heavy SWAT",	
  ene_omnia_spook = "OMNIA Cloaker",
  ene_omnia_taser = "OMNIA Taser",
  ene_omnia_hrt = "OMNIA SRT",    
  ene_omnia_crew = "OMNIA Crewman",          
  ene_omnia_medic = "OMNIA Medic",
  ene_omnia_sniper = "OMNIA Sniper", 
  ene_omnia_city = "OMNIA Light",
  ene_omnia_heavy = "OMNIA Heavy",
  ene_omnia_shield = "OMNIA Shield",
  ene_swat_1_sc = "SWAT",
  ene_swat_2_sc = "SWAT",
  ene_tazer_1_sc = "Taser",	
  ene_shield_1_sc = "FBI Shield",
  ene_shield_2_sc = "SWAT Shield",
  ene_sniper_1_sc = "SWAT Sniper",	
  ene_sniper_2_sc = "FBI Sniper",	
  ene_sniper_3 = "GenSec Sniper",
  ene_fbi_swat_1_sc = "FBI SWAT",
  ene_fbi_swat_2_sc = "FBI SWAT",
  ene_fbi_heavy_1_sc = "FBI Heavy SWAT",  
  ene_fbi_heavy_r870_sc = "FBI Heavy SWAT",
  ene_bravo_guard_1 = "National Guard Security",
  ene_bravo_guard_2 = "National Guard Security",
  ene_bravo_guard_3 = "National Guard Elite Security", 
  ene_bravo_shotgun = "National Guard Shotgunner",
  ene_bravo_shotgun_murky = "OMNIA Shotgunner",   
  ene_bravo_shotgun_ru = "AKAN Containment Team Shotgunner",    
  ene_bravo_shotgun_mex = "Ejército Mexicano Shotgunner",    
  ene_bravo_rifle = "National Guard Rifleman",
  ene_bravo_rifle_murky = "OMNIA Rifleman", 
  ene_bravo_rifle_ru = "AKAN Containment Team Rifleman", 
  ene_bravo_rifle_mex = "Ejército Mexicano Rifleman", 
  ene_bravo_lmg = "National Guard Gunner",
  ene_bravo_lmg_murky = "OMNIA Gunner",   
  ene_bravo_lmg_ru = "AKAN Containment Team Gunner", 
  ene_bravo_lmg_mex = "Ejército Mexicano Gunner",
  ene_bravo_dmr = "National Guard Marksman",
  ene_bravo_dmr_scripted = "National Guard Marksman",
  ene_bravo_dmr_murky = "OMNIA Marksman",
  ene_bravo_dmr_ru = "AKAN Containment Team Marksman",
  ene_bravo_dmr_mex = "Ejército Mexicano Marksman",
  ene_swat_heavy_r870_sc = "Heavy SWAT",  
  ene_titan_taser = "OMNIA Titan Taser",
  ene_titan_sniper = "OMNIA Titan Sniper",
  ene_titan_sniper_scripted = "OMNIA Titan Sniper",
  ene_titan_shotgun = "OMNIA Titan SWAT",
  ene_titan_rifle = "OMNIA Titan SWAT",   
  ene_omnia_lpf = "OMNIA LPF",
  ene_akan_lpf = "D-1001 ZETA LPF",
  ene_fbi_titan = "OMNIA ASU",    
  ene_vip = "Captain Winters",
  ene_phalanx_1 = "Winters Minion Shield",
  ene_phalanx_1_assault = "OMNIA Titan Shield",
  ene_titan_grenadier = "Titan Grenadier", 
  ene_skele_swat = "Skeleton SWAT", 
  ene_vip_2 = "OMNIA Titandozer",  
  ene_vip_2_assault = "OMNIA Titandozer",
  ene_vip_autumn = "Captain Autumn",
  ene_summers = "Captain Summers",
  ene_phalanx_taser = "Engineer Elektra",
  ene_phalanx_grenadier = "Major Molly",  
  ene_phalanx_medic = "Sergeant Doc",    
  ene_spring = "Captain Spring",
  ene_zeal_sniper = "National Guard Sniper",
  ene_zeal_tazer_sc = "National Guard Taser",
  ene_zeal_cloaker_sc = "National Guard Cloaker",	
  ene_zeal_swat_shield_sc = "National Guard Shield",	
  ene_zeal_bulldozer_2_sc = "National Guard Bulldozer",	
  ene_zeal_bulldozer_3_sc = "National Guard Blackdozer",	
  ene_zeal_bulldozer_sc = "National Guard Skulldozer",	
  ene_zeal_city = "National Guard Gunner",  
  ene_zeal_fbi = "National Guard HRT",  
  ene_zeal_swat_heavy_sc = "National Guard Heavy Gunner",        
  ene_zeal_swat_heavy_r870_sc = "National Guard Heavy Shotgunner",
  ene_zeal_swat_heavy_benelli = "National Guard Heavy Shotgunner",
  ene_zeal_medic = "National Guard Medic",
  ene_male_office_cop = "Policía",
  ene_policia = "Policía",
  ene_murky_fbi_tank_m249 = "Murky Skulldozer",  
  ene_murky_fbi_tank_benelli = "Murky Benellidozer", 
  ene_murky_fbi_tank_medic = "Murky Medicdozer",
  ene_murky_fbi_tank_r870 = "Murky Bulldozer",    
  ene_murky_fbi_tank_r870_hard = "Murky Bulldozer", 
  ene_murky_fbi_tank_saiga = "Murky Blackdozer",    
  ene_veteran_enrique = "Enrique Caín",
  ene_headless_hatman = "Horseless Hatless Headless Titan Dozer from Hell",
  ene_city_guard = "FTSU Field Agent",
  ene_deep_security = "Bellmead Security",
  ene_male_marshal_marksman_1 = "Marshal Marksman",
  ene_male_marshal_marksman_2 = "Bellmead Marksman",
  ene_male_marshal_marksman_scripted_2 = "Bellmead Marksman",
  ene_male_marshal_shield_1 = "Marshal Shield Trooper",
  ene_male_marshal_shield_2 = "Bellmead Shield Trooper",
  ene_hoxton_breakout_guard = "FBI Ready Team",
  ene_hoxton_breakout_responder = "FBI Ready Team",
  ene_male_security_penthouse = "Penthouse Security",
  ene_male_kungfumaster = "Yufu Wang's Personal Bodyguard",
  ene_gang_colombian = "Colombian Thug",
  ene_gang_colombian_boss = "Colombian Boss",
  ene_gang_colombian_enforcer = "Colombian Enforcer",
  ene_gang_black_enforcer = "Cobra Enforcer",
  ene_gang_mobster_enforcer = "Mobster Enforcer",
  ene_bulldozer_biker_1 = "OVERKILL MC Bikerdozer",
  ene_bulldozer_snowman = "Snowmandozer",
  ene_dozer_piggy = "Warthog",
  ene_male_ranc_security = "Security Ranch Guard",
  ene_gang_black = "Cobra Thug",
  ene_gang_mexican = "Cartel Thug",
  ene_gang_russian = "Russian Thug",
  ene_biker = "OVERKILL MC Biker",
  ene_guard_biker = "OVERKILL MC Biker Guard",
  ene_biker_female = "OVERKILL MC Female Biker",
  ene_gang_biker_boss = "OVERKILL MC Boss",
  ene_thug_indoor = "Bolivian Thug",
  ene_bolivian_thug_outdoor = "Bolivian Thug",
  ene_rus_cop_1 = "Russian Cop",
  ene_rus_cop_2 = "Russian Cop",
  ene_rus_cop_3_r870 = "Russian Cop",
  ene_rus_cop_3_mp5 = "Russian Cop",
  ene_rus_cop_4_m4 = "Russian Cop",
  ene_rus_cop_4_r870 = "Russian Cop",
  ene_rus_fsb_m4 = "FSB Tactical Unit",
  ene_rus_fsb_r870 = "FSB Tactical Unit",
  ene_rus_fsb_heavy_m4 = "FSB Heavy Tactical Unit",
  ene_rus_shield_c45 = "FSB Tactical Shield",
  ene_rus_shield_sr2 = "FSB Tactical Shield",
  ene_rus_fsbcity_g36 = "FSB Veteran",
  ene_rus_fsbcity_r870 = "FSB Veteran",
  ene_rus_fsbzeal_akmsu = "FSB Veteran",
  ene_rus_fsbzeal_heavy_ak47_ass = "FSB Veteran Heavy",
  ene_rus_fsbcity_heavy_g36 = "FSB Veteran Heavy",
  ene_rus_shield_sr2_city = "FSB Veteran Shield",
  ene_rus_sniper = "FSB Sniper",
  ene_rus_security = "Russian Security",
  ene_rus_prisoner = "Prisoner",
  civ_rus_prisoner = "Prisoner",
  civ_rus_prisoner_special = "Prisoner",
  npc_ivan = "Ivan",
  npc_nikolai = "Nikolai",
  npc_backup = "Nikolai's Man",
  civ_kozlov = "Dimitri Kozlov",
  civ_diego = "Diego",
  ene_diego_backup = "Diego's Man",
  ene_friendly_backup = "Constantine's Man",
  civ_informant = "Informant",
  ene_gang_mobster = "Mobster Thug",
  ene_gang_mobster_1_pager = "Mobster Thug",
  ene_gang_mobster_2_pager = "Mobster Thug",
  ene_gang_mobster_3_pager = "Mobster Thug",
  ene_gang_mobster_4_pager = "Mobster Thug",
  ene_gang_mobster_5_pager = "Mobster Thug",
  ene_gang_mobster_6_pager = "Mobster Thug",
  ene_gang_mobster_7_pager = "Mobster Thug",
  ene_security_resort = "Resort Security Guard",
  ene_gang_mobster_armored = "Armored Mobster",
  ene_gang_mobster_clubowner = "Club Owner",
  ene_gang_mobster_clubsecurity = "Club Security", 
  ene_gang_mobster_mobboss = "Mobster Boss",
  ene_gang_mobster_vip = "VIP Mobster",
  ene_cartel_rebel = "Valerio Cartel Rebel",
  ene_cartel_security = "Valerio Cartel Security Guard",
  ene_cartel_suit = "Valerio Cartel Security Guard",
  ene_cartel_clubowner = "Valerio Cartel Club Owner",
  ene_cartel_scout = "Valerio Cartel Scout",
  ene_cartel_bulldozer = "Valerio Cartel Armored Enforcer", 
  ene_cartel_commando = "Valerio Cartel Commander",
  ene_cartel_grenadier = "Valerio Cartel Grenadier Enforcer",
  ene_cartel_tazer = "Valerio Cartel Stunner",
  ene_cartel_tazer_normal = "Valerio Cartel Stunner",
  ene_cartel_shield = "Valerio Cartel Shield",
  ene_cartel_soldier = "Valerio Cartel Soldier",
  ene_cartel_soldier_shotgun = "Valerio Cartel Soldier",
  ene_cartel_soldier_heavy = "Valerio Cartel Heavy Soldier",
  ene_cartel_soldier_heavy_shotgun = "Valerio Cartel Heavy Soldier",
  ene_cartel_soldier_fbi = "Valerio Cartel Veteran Soldier",
  ene_cartel_soldier_fbi_shotgun = "Valerio Cartel Veteran Soldier",
  ene_cartel_soldier_heavy_fbi = "Valerio Cartel Heavy Veteran Soldier",
  ene_cartel_soldier_heavy_fbi_shotgun = "Valerio Cartel Heavy Veteran Soldier",
  ene_cartel_soldier_city = "Valerio Cartel Elite Soldier",
  ene_cartel_soldier_city_shotgun = "Valerio Cartel Elite Soldier",
  ene_cartel_soldier_heavy_city = "Valerio Cartel Heavy Elite Soldier",
  ene_xof_rpg = "XOF Piglet Unit",
  ene_zeal_warthog = "National Guard Warthog",
  ene_norm_warthog = "Warthog",
  ene_bulldozer_medic_sc = "National Guard Medicdozer"
		})
end)
