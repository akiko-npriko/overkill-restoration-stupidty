...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Perk_Decks_Eng", function(loc)
	LocalizationManager:add_localized_strings({
		...
		--MOD PERK DECKS
				...
				["menu_deck_Armor_1_desc"] = "Unlocks the Armor Plate Bag as a Throwable.\n\nActivating the Armor Plate Bag will replace the plates in your carrier.\nCompletely restoring armor and giving you ##2## seconds of invulnerability.\n\nHeavier Armor will reduce the amount of charges the Plate bag has.\nEach Charge has a ##60## second cooldown.\nKills will reduce the cooldown by ##6## seconds.",

				["menu_deck_Armor_3"] = "Armor Plate 2",
				["menu_deck_Armor_3_short"] = "You gain ##10%## more armor.",
				["menu_deck_Armor_3_desc"] = "You gain ##10%## more armor.",

				["menu_deck_Armor_5"] = "Armor Plate 3",
				["menu_deck_Armor_5_short"] = "Segments your armor into ##1##/##2##/##3##/##4## 'plates' depending on equipped armor.\n\nWhen a plate breaks you gain ##1## second of invulnerability.\nAfter plates break, they can only be regenerated by using the Plate Bag.",
				["menu_deck_Armor_5_desc"] = "Segments your armor into ##1##/##2##/##3##/##4## 'plates' depending on equipped armor.\n\nWhen a plate breaks you gain ##1## second of invulnerability.\nAfter plates break, they can only be regenerated by using the Plate Bag.",

				["menu_deck_Armor_7"] = "Armor Plate 4",
				["menu_deck_Armor_7_short"] = "You gain ##20%## more armor.",
				["menu_deck_Armor_7_desc"] = "You gain ##20%## more armor.",
