...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["Overkill-Restoration-StupidtyOptionsButtonTitleID"] = "Opciones De Restoration Mod",
		["Overkill-Restoration-StupidtyOptionsButtonDescID"] = "Opciones de Restoration Mod",
		["Overkill-Restoration-StupidtyHUDOptionsButtonTitleID"] = "Opciones Del HUD & UI De Restoration",
		["Overkill-Restoration-StupidtyHUDOptionsButtonDescID"] = "Opciones del HUD & UI de Restoration",
		["Overkill-Restoration-StupidtyOTHEROptionsButtonTitleID"] = "Opciones Adicionales De Restoration Mod",
		["Overkill-Restoration-StupidtyOTHEROptionsButtonDescID"] = "Opciones adicionales de Restoration Mod",
		["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonTitleID"] = "++ Opciones De Manejo De Armas ++",
		["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonDescID"] = "Opciones adicionales de manejo de armas.",
		["Overkill-Restoration-StupidtyUIOptionsButtonTitleID"] = "Interfaz Alfa",
		["Overkill-Restoration-StupidtyUIOptionsButtonDescID"] = "Opciones de interfaz Alfa.",
		["Overkill-Restoration-StupidtyTimeOfDayTitleID"] = "Nuevas + Horas Aleatorias De Días",
		["Overkill-Restoration-StupidtyTimeOfDayDescID"] = "Permite personalizar la hora del día en ciertos trabajos.",

		["Overkill-Restoration-StupidtyOtherModsTitleID"] = "===Opciones De Otros Mods===",
		["Overkill-Restoration-StupidtyOtherModsDescID"] = "Opciones adicionales para otros mods",
			["Overkill-Restoration-StupidtyAdVMovResOptOptionsButtonTitleID"] = "Opciones de\"Advanced Movement Standalone\"",
			["Overkill-Restoration-StupidtyAdVMovResOptOptionsButtonDescID"] = "Opciones adicionales para Cola en solitario del mod \"Advanced Movement Standalone\" de Pixy",

		["restoration_level_data_unknown"] = "HORA DESCONOCIDA, LUGAR DESCONOCIDO",
		["Overkill-Restoration-StupidtyEnv_BanksTitleID"] = "Banco Sucursal",
		["Overkill-Restoration-StupidtyEnv_BanksDescID"] = "Selecciona un ambiente para Banco Sucursal.",
		["Overkill-Restoration-StupidtyEnv_RVD1TitleID"] = "Reservoir Dogs Día 1",
		["Overkill-Restoration-StupidtyEnv_RVD1DescID"] = "Selecciona un ambiente para Reservoir Dogs Día 1.",
		["Overkill-Restoration-StupidtyEnv_RVD2TitleID"] = "Reservoir Dogs Día 2",
		["Overkill-Restoration-StupidtyEnv_RVD2DescID"] = "Selecciona un ambiente para Reservoir Dogs Día 2.",
		["Overkill-Restoration-StupidtyEnv_FSD1TitleID"] = "Pirómanos Día 1",
		["Overkill-Restoration-StupidtyEnv_FSD1DescID"] = "Selecciona un ambiente para Pirómanos Día 1.",
		["Overkill-Restoration-StupidtyEnv_PBR2TitleID"] = "Nacimiento En El Cielo",
		["Overkill-Restoration-StupidtyEnv_PBR2DescID"] = "Selecciona un ambiente para Nacimiento En El Cielo.",
		["Overkill-Restoration-StupidtyEnv_CJ2TitleID"] = "La Bomba: Astillero",
		["Overkill-Restoration-StupidtyEnv_CJ2DescID"] = "Selecciona un ambiente para La Bomba: Astillero.",
		["Overkill-Restoration-StupidtyEnv_UnderPassTitleID"] = "Paso A Desnivel",
		["Overkill-Restoration-StupidtyEnv_UnderPassDescID"] = "Selecciona un ambiente para Transporte - Paso A Desnivel.",
		["Overkill-Restoration-StupidtyEnv_MallCrasherTitleID"] = "Destrozacentros",
		["Overkill-Restoration-StupidtyEnv_MallCrasherDescID"] = "Selecciona un ambiente para Destrozacentros.",
		["Overkill-Restoration-StupidtyEnv_Mia_1TitleID"] = "Hotline Miami Día 1",
		["Overkill-Restoration-StupidtyEnv_Mia_1DescID"] = "Selecciona un ambiente para Hotline Miami Día 1.",
		["Overkill-Restoration-StupidtyEnv_FSD3TitleID"] = "Pirómanos Día 3",
		["Overkill-Restoration-StupidtyEnv_FSD3DescID"] = "Selecciona un ambiente para Pirómanos Día 3.",
		["Overkill-Restoration-StupidtyEnv_WDD1NTitleID"] = "Guardianes Día 1 (Noche)",
		["Overkill-Restoration-StupidtyEnv_WDD1NDescID"] = "Selecciona un ambiente para Perros Guardianes Día 1 (Noche).",
		["Overkill-Restoration-StupidtyEnv_WDD1DTitleID"] = "Guardianes Día 1 (Día)",
		["Overkill-Restoration-StupidtyEnv_WDD1DDescID"] = "Selecciona un ambiente para Perros Guardianes Día 1 (Día).",
		["Overkill-Restoration-StupidtyEnv_WDD2DTitleID"] = "Guardianes Día 2 (Día)",
		["Overkill-Restoration-StupidtyEnv_WDD2DDescID"] = "Selecciona un ambiente para Perros Guardianes Día 2 (Día).",
		["Overkill-Restoration-StupidtyEnv_Alex3TitleID"] = "Ratas Día 3",
		["Overkill-Restoration-StupidtyEnv_Alex3DescID"] = "Selecciona un ambiente para Ratas Día 3.",
		["Overkill-Restoration-StupidtyEnv_BigTitleID"] = "El Gran Banco",
		["Overkill-Restoration-StupidtyEnv_BigDescID"] = "Selecciona un ambiente para El Gran Banco.",
		["Overkill-Restoration-StupidtyEnv_FSTitleID"] = "Cuatro Tiendas",
		["Overkill-Restoration-StupidtyEnv_FSDescID"] = "Selecciona un ambiente para Cuatro Tiendas.",
		["Overkill-Restoration-StupidtyEnv_UkraTitleID"] = "Al Estilo Ucraniano",
		["Overkill-Restoration-StupidtyEnv_UkraDescID"] = "Selecciona un ambiente para Al Estilo Ucraniano.",
		["Overkill-Restoration-StupidtyEnv_KosugiTitleID"] = "Incursión Sombra",
		["Overkill-Restoration-StupidtyEnv_KosugiDescID"] = "Selecciona un ambiente para Incursión Sombra.",
		["Overkill-Restoration-StupidtyEnv_PetaTitleID"] = "Goat Simulator Día 1",
		["Overkill-Restoration-StupidtyEnv_PetaDescID"] = "Selecciona un ambiente para Goat Simulator Día 1.",
		["Overkill-Restoration-StupidtyEnv_FRIENDTitleID"] = "La Mansión De Scarface",
		["Overkill-Restoration-StupidtyEnv_FRIENDDescID"] = "Selecciona un ambiente para La Mansión De Scarface.",
		["Overkill-Restoration-StupidtyINFOHUDOptionsButtonTitleID"] = "Rastreador de Bufos",
		["Overkill-Restoration-StupidtyINFOHUDOptionsButtonDescID"] = "Muestra iconos para reflejar información sobre las habilidades activas en la parte izquierda de la pantalla. No requiere activar Interfaz Alfa.",
		["Overkill-Restoration-StupidtyInfo_HudTitleID"] = "Activar Rastreador De Bufos.",
		["Overkill-Restoration-StupidtyInfo_HudDescID"] = "Activa o desactiva toda la interfaz del rastreador de Bufos.",
		["Overkill-Restoration-StupidtyInfo_SizeTitleID"] = "Tamaño De Icono",
		["Overkill-Restoration-StupidtyInfo_SizeDescID"] = "Controla el tamaño de los iconos en el rastreador de Bufos.",
		["Overkill-Restoration-StupidtyInfo_CountTitleID"] = "Número De Filas",
		["Overkill-Restoration-StupidtyInfo_CountDescID"] = "Controla el número de filas que el rastreador de bufos muestra antes de añadir una nueva columna.",
		["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadTitleID"] = "Recarga Agresiva",
		["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_ammo_efficiencyTitleID"] = "Eficiencia Municiosa",
		["Overkill-Restoration-StupidtyInfo_ammo_efficiencyDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedTitleID"] = "Sed de Sangre",
		["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_bullet_stormTitleID"] = "Lluvia de Balas",
		["Overkill-Restoration-StupidtyInfo_bullet_stormDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_revive_damage_reductionTitleID"] = "Médico Combatiente",
		["Overkill-Restoration-StupidtyInfo_revive_damage_reductionDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_desperadoTitleID"] = "Desperado",
		["Overkill-Restoration-StupidtyInfo_desperadoDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_grinderTitleID"] = "Histamina (Grinder)",
		["Overkill-Restoration-StupidtyInfo_grinderDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_infiltratorTitleID"] = "Absorción de Salud (Espía)",
		["Overkill-Restoration-StupidtyInfo_infiltratorDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_sociopathTitleID"] = "Tension y Otros (Sociópata)",
		["Overkill-Restoration-StupidtyInfo_sociopathDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_body_expertiseTitleID"] = "Regar y Rogar",
		["Overkill-Restoration-StupidtyInfo_body_expertiseDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_long_dis_reviveTitleID"] = "Inspiración",
		["Overkill-Restoration-StupidtyInfo_long_dis_reviveDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_messiahTitleID"] = "Mesías",
		["Overkill-Restoration-StupidtyInfo_messiahDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierTitleID"] = "Overkill",
		["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_revived_damage_reductionTitleID"] = "Analgésicos",
		["Overkill-Restoration-StupidtyInfo_revived_damage_reductionDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionTitleID"] = "Urgencia Médica",
		["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_rogueTitleID"] = "Instinto Asesino (Renegado)",
		["Overkill-Restoration-StupidtyInfo_rogueDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_increased_movement_speedTitleID"] = "Evadiendo la Muerte",
		["Overkill-Restoration-StupidtyInfo_increased_movement_speedDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multTitleID"] = "Pulso Firme",
		["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_trigger_happyTitleID"] = "Gatillo Fácil",
		["Overkill-Restoration-StupidtyInfo_trigger_happyDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedTitleID"] = "Mal Perdedor",
		["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_unseen_strikeTitleID"] = "Ataque Sorpresa",
		["Overkill-Restoration-StupidtyInfo_unseen_strikeDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_survive_one_hitTitleID"] = "Oni Irezumi (Yakuza)",
		["Overkill-Restoration-StupidtyInfo_survive_one_hitDescID"] = "Activa o desactiva el rastreo de esta habilidad específica.",
		["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenTitleID"] = "Regeneración de salud del Botiquín Médico",
		["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenDescID"] = "Activa o desactiva el rastreo de la regeneración de salud del Botiquín Médico.",

		--EXTRA OPTIONS
		["Overkill-Restoration-StupidtyAltLastDownColorTitleID"] = "Color Alternativo De Ultiva Vida",
		["Overkill-Restoration-StupidtyAltLastDownColorDescID"] = "Cambia el color de última vida a color_sin_classic.",
		["Overkill-Restoration-StupidtyNoBleedoutTiltTitleID"] = "Desactivar inclinación cámara incapacitado",
		["Overkill-Restoration-StupidtyNoBleedoutTiltDescID"] = "Desactiva la inclinación de la cámara al ser incapacitado.",
		["Overkill-Restoration-StupidtyGOTTAGETAGRIPTitleID"] = "Ocultar TODAS las empuñaduras",
		["Overkill-Restoration-StupidtyGOTTAGETAGRIPDescID"] = "Oculta *todos* los accesorios del tipo \"empuñadura_vertical\" para que no aparezcan en los menús; los que ya están acoplados a las armas no se ven afectados. Requiere reinicio.",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTitleID"] = "Armas Super Cereal",
		["Overkill-Restoration-StupidtyGCGPYPMMSACDescID"] = "Desactiva las mecánicas de los blasters de Star Wars. Requiere reinicio.",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTextTitleID"] = "Texto Super Cereal",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTextDescID"] = "Desactiva los easter eggs basados en texto. Requiere reinicio.",
		["Overkill-Restoration-StupidtyForceEggsOptionsButtonTitleID"] = "Forzar Texto De Easter Eggs",
		["Overkill-Restoration-StupidtyForceEggsOptionsButtonDescID"] = "Forzar easter eggs de textos individuales ignora los efectos de \"Texto Super Cereal\" si está activado.\nCambiar cualquier cosa aquí requiere un reinicio.",
			["Overkill-Restoration-StupidtyUpotteTitleID"] = "Inscribirse en la Academia Seishou",
			["Overkill-Restoration-StupidtyUpotteDescID"] = "Trabaja con el profesor de Literatura Moderna o algo así",
			["Overkill-Restoration-StupidtyMyWifeTitleID"] = "G Menos que 3",
			["Overkill-Restoration-StupidtyMyWifeDescID"] = "Las maquinaciones internas de la mente de DMC son un enigma", --Bob: No se a que se refiere esto
			["Overkill-Restoration-StupidtyCrabBattleTitleID"] = "Este Sí Que Es Un Bonito Meme",
			["Overkill-Restoration-StupidtyCrabBattleDescID"] = "¡Exquisito!",
			["Overkill-Restoration-StupidtyEmberMyBelovedTitleID"] = "Ir Digital EXTREMO",
			["Overkill-Restoration-StupidtyEmberMyBelovedDescID"] = "Clem Grakata!",
			["Overkill-Restoration-StupidtyBigManTitleID"] = ":^)",
			["Overkill-Restoration-StupidtyBigManDescID"] = "Habilita otros textos de easter egg",
		["Overkill-Restoration-StupidtySevenHoldTitleID"] = "Alternar interacciones (Pulsa una vez para mantener)",
		["Overkill-Restoration-StupidtySevenHoldDescID"] = "Activa/desactiva si la tecla para interactuar actúa o no como interruptor.",
		["Overkill-Restoration-StupidtySevenHoldDeployCancelTitleID"] = "Desplegable Cancela Interactuar",
		["Overkill-Restoration-StupidtySevenHoldDeployCancelDescID"] = "Activa/desactiva si la tecla para desplegables es la que se utiliza para cancelar una interacción activa. Requiere que alternar interaciones esté activado para tener efecto.",
		["Overkill-Restoration-StupidtyClassicMoviesTitleID"] = "Fondos De Carga Clásicos",
		["Overkill-Restoration-StupidtyClassicMoviesDescID"] = "Activa o desactiva los fondos de carga de PD:TH cuando juegues en trabajos clásicos.",
		["Overkill-Restoration-StupidtyWpnCatTitleID"] = "Categorías Mercado Negro",
		["Overkill-Restoration-StupidtyWpnCatDescID"] = "Cambia el método de agrupamiento de armas utilizado al comprar un arma en el menú del mercado negro. Requiere reinicio.",
			["base_wpn_cat"] = "habilidad base",
			["sub_wpn_cat"] = "subcategoría y grado de daño",

		["Overkill-Restoration-StupidtyWepNamesTitleID"] = "(Re)Nombres De Armas",
		["Overkill-Restoration-StupidtyWepNamesDescID"] = "Cambia el estilo de los nombres de armas y accesorios. Requiere reinicio.",
		...
		["Overkill-Restoration-StupidtyDisableAdvMovTFTitleID"] = "Desactivar Correr por pared/Saltar",
		["Overkill-Restoration-StupidtyDisableAdvMovTFDescID"] = "Desactiva los aspectos de correr por la pared/saltar de Advanced Movement.",
		["Overkill-Restoration-StupidtyAdvMovMeleeTitleID"] = "Comportamiento CaC",
		["Overkill-Restoration-StupidtyAdvMovMeleeDescID"] = "Cambia el comportamiento del salto/deslizamiento/impulso/patada de Advanced Movement.",
			["resmod_advmov_melee_on"] = "Predeterminado",
			["resmod_advmov_melee_loud_only"] = "Solo En Combate",
			["resmod_advmov_melee_off"] = "Deshabilitado",

		--WEAPON HANDLING
		["Overkill-Restoration-StupidtyStaticAimTitleID"] = "Sin Movimiento De Armas Mientras Apuntas",
		["Overkill-Restoration-StupidtyStaticAimDescID"] = "Activa/desactiva el balanceo y la desviación cosméticas al apuntar; anula la configuración de \"Movimiento de Viewmodel\" cuando está activada. Requiere reinicio. ADVERTENCIA: PUEDE INUTILIZAR ALGUNAS MIRAS SI NO SE MARCA.",
		["Overkill-Restoration-StupidtyBigScopeOffsetTitleID"] = "\"Miras Grandes\" Compensación De Viewmodel",
		["Overkill-Restoration-StupidtyBigScopeOffsetDescID"] = "Inclina y desplaza ligeramente hacia la derecha los viewmodels al disparar desde la cadera cuando se utilizan miras grandes para reducir las obstrucciones visuales.",
		["Overkill-Restoration-StupidtyViewmodelMovementTitleID"] = "Mov. del Viewmodel",
		["Overkill-Restoration-StupidtyViewmodelMovementDescID"] = "Elige cómo se mueve el viewmodel de tus armas al mirar a tu alrededor; el movimiento al apuntar es anulado por la opción \"Sin Movimiento De Armas Mientras Apuntas\" si está activada. Requiere reinicio.",
		...
		["Overkill-Restoration-StupidtyCarpalTunnelTitleID"] = "Auto-Rec. Retroceso",
		["Overkill-Restoration-StupidtyCarpalTunnelDescID"] = "Elige cómo funciona la mecánica de auto-recuperación del retroceso. Las versiones activadas se equilibran de forma diferente.",
			["rr_off"] = "Desactivado",
			["rr_per_weapon"] = "Específico De Arma",
			["rr_full"] = "Completo",
		["Overkill-Restoration-StupidtyAutoDMRsTitleID"] = "Los DMR Comienzan En Automático",
		["Overkill-Restoration-StupidtyAutoDMRsDescID"] = "Activa o desactiva que todos los DMR con modos de disparo semiautomático y automático empiecen en modo automático.",
		["Overkill-Restoration-StupidtyWpnFireDescopeTitleID"] = "Permitir Anular Apuntado De Ciertas Armas",
		["Overkill-Restoration-StupidtyWpnFireDescopeDescID"] = "Activa/Desactiva Anular apuntado de armas al disparar. NOTA: Reduce errores visuales; algunas miras pueden atravesar la cámara si se desactiva. Se ignora en armas que mencionan el anulado como mecánica.",
		["Overkill-Restoration-StupidtySprintCancelTitleID"] = "Corredor As Cancela Recargas Al Esprintar",
		["Overkill-Restoration-StupidtySprintCancelDescID"] = "Alterna si *INICIAR* un sprint cancelará cualquier recarga en curso cuando hayas conseguido la habilidad \"Corredor AS\". La recarga mientras esprintas activamente no se ve afectada.",
		["Overkill-Restoration-StupidtyQueuedShootingTitleID"] = "Búfer Para Disparar",
		["Overkill-Restoration-StupidtyQueuedShootingDescID"] = "Activa/desactiva el búfer para semiautomáticas para ayudar con el oversampling.\nActivar esta opción desactiva la versión de Overkill del búfer.",
		["Overkill-Restoration-StupidtyQueuedShootingWindowTitleID"] = "Sensibilidad Del Búfer De Disparo Único",
		["Overkill-Restoration-StupidtyQueuedShootingWindowDescID"] = "Determina la ventana de tiempo para que los disparos sean almacenados en el búfer basándose en un % del retardo de disparo del arma. Mayor valor = búfer más temprano",
		["Overkill-Restoration-StupidtyQueuedShootingExcludeTitleID"] = "Límite De Cadencia De Tiro Del Búfer",
		["Overkill-Restoration-StupidtyQueuedShootingExcludeDescID"] = "Limita el almacenamiento en búfer de los disparos a las armas que disparan *por encima* de la cadencia de fuego (RPM) establecida por esta opción.",
		["Overkill-Restoration-StupidtyQueuedShootingMidBurstTitleID"] = "Búfer A Mitad De Ráfaga",
		["Overkill-Restoration-StupidtyQueuedShootingMidBurstDescID"] = "Buffer de disparos realizados *durante* una ráfaga.",
		["Overkill-Restoration-StupidtyQueuedShootingBurstExcludeTitleID"] = "Límite De Búfer A Mitad De Ráfaga",
		["Overkill-Restoration-StupidtyQueuedShootingBurstExcludeDescID"] = "Limita el almacenamiento en búfer de disparos realizados *durante* una ráfaga a las armas que tienen un retardo de ráfaga *inferior* al valor (ms) establecido por esta opción.",
		["Overkill-Restoration-StupidtyNoADSRecoilAnimsTitleID"] = "Sin Animaciones De Retroceso Al Apuntar",
		["Overkill-Restoration-StupidtyNoADSRecoilAnimsDescID"] = "Activa/desactiva las animaciones de retroceso al apuntar. Esta opción no afecta a algunas armas (por ejemplo, armas manuales, arcos y lanzallamas).",
		["Overkill-Restoration-StupidtyNoSwapOnReviveTitleID"] = "Sin Cambio Forzado De Armas Al Ser Reanimado",
		["Overkill-Restoration-StupidtyNoSwapOnReviveDescID"] = "Desactiva el cambio de arma forzado al ser reanimado cuando se te incapacita con una primaria sin la habilidad Inmortal As.",
		["Overkill-Restoration-StupidtyManualReloadsTitleID"] = "Recargas Manuales",
		["Overkill-Restoration-StupidtyManualReloadsDescID"] = "Desactiva las recargas automáticas cuando el cargador está vacío. NOTA: Esta opción se ignora si el mutador \"Maratón De Recarga\" está activo.",
		["Overkill-Restoration-StupidtySecondSightSprintTitleID"] = "Botón De Esprintar Para Alternar La Mira",
		["Overkill-Restoration-StupidtySecondSightSprintDescID"] = "Usa el botón de esprintar para alternar las miras mientras estás apuntando.\nLos gadgets podrán cambiarse como antes de la U232, pero no podrás iniciar esprint mientras apuntas.",
		["Overkill-Restoration-StupidtyADSTransitionStyleTitleID"] = "Estilo De Apuntado",
		["Overkill-Restoration-StupidtyADSTransitionStyleDescID"] = "Cambia el estilo de transición al apuntar con la mira.",
			["vanilla_on_rails"] = "Predeterminado/En Rieles",
			["kf_mw_style"] = "Estilo de KF1/CoD",
			["tilt_in"] = "Inclinado Hacia Dentro",
		["Overkill-Restoration-StupidtyAimDeploysBipodTitleID"] = "Apuntar Despliega Bípodes",
		["Overkill-Restoration-StupidtyAimDeploysBipodDescID"] = "Activa/desactiva el despliegue automático de los bípodes cuando apuntas sobre una superficie válida.",
		["Overkill-Restoration-StupidtyMoveCancelBipodTitleID"] = "Moverse Desmonta Bípode",
		["Overkill-Restoration-StupidtyMoveCancelBipodDescID"] = "Activa/desactiva desmontado de los bípodes al moverse.",
		["Overkill-Restoration-StupidtySeparateBowADSTitleID"] = "Apuntar Con Arco Por Separado",
		["Overkill-Restoration-StupidtySeparateBowADSDescID"] = "Desactiva el apuntado forzado con arcos al tensar una flecha. Si está activada, la tecla de recarga se usa para soltar la flecha.",
		["Overkill-Restoration-StupidtyPerPelletShotgunsTitleID"] = "Daño de escopeta por perdigón (NO TERMINADO)",
		["Overkill-Restoration-StupidtyPerPelletShotgunsDescID"] = "El daño de la escopeta se calcula por perdigón, a diferencia del predeterminado \"1 perdigón = daño completo, disparos en la cabeza tienen prioridad\".Se incrementa el daño de escopetas sin proyectiles para compensar la consistencia reducida. Requiere reinicio.",
		...
		["Overkill-Restoration-StupidtyPaintingsTitleID"] = "Cuadros No Utilizados En Galería De Arte",
		["Overkill-Restoration-StupidtyPaintingsDescID"] = "Activa o desactiva la posibilidad de que los cuadros no utilizados aparezcan en la Galería de Arte. Sólo funciona como anfitrión.",
		["Overkill-Restoration-StupidtyMainHUDTitleID"] = "HUD Alfa ON/OFF",
		["Overkill-Restoration-StupidtyMainHUDDescID"] = "Activa o desactiva el  por completo.",
		["Overkill-Restoration-StupidtyWaypointsTitleID"] = "Marcadores Alfa",
		["Overkill-Restoration-StupidtyWaypointsDescID"] = "Activar o desactivar los marcadores Alfa.",
		["Overkill-Restoration-StupidtyAssaultPanelTitleID"] = "Cinta de Asalto Alfa",
		["Overkill-Restoration-StupidtyAssaultPanelDescID"] = "Activa o desactiva la Cinta de Asalto Alfa.",
		["Overkill-Restoration-StupidtyAltAssaultTitleID"] = "Indicador De Asalto Alfa Temprana",
		["Overkill-Restoration-StupidtyAltAssaultDescID"] = "Activa o desactiva el Indicador de Asalto de la Alfa Temprana. Sustituye a la cinta.",
		["Overkill-Restoration-StupidtyObjectivesPanelTitleID"] = "Panel de Objetivos Alfa",
		["Overkill-Restoration-StupidtyObjectivesPanelDescID"] = "Activar o desactivar el Panel de Objetivos Alfa.",
		["Overkill-Restoration-StupidtyPresenterTitleID"] = "Presentador Alfa",
		["Overkill-Restoration-StupidtyPresenterDescID"] = "Activa o desactiva el Presentador Alfa, que se utiliza para el botín asegurado y el diálogo de recordatorio de objetivo.",
		["Overkill-Restoration-StupidtyInteractionTitleID"] = "Medidor De Interacción Alfa",
		["Overkill-Restoration-StupidtyInteractionDescID"] = "Activa o desactiva el medidor de Interacción Alfa.",
		["Overkill-Restoration-StupidtyStealthTitleID"] = "Medidor De sigilo Alfa",
		["Overkill-Restoration-StupidtyStealthDescID"] = "Activa o desactiva el medidor de sigilo Alfa.",
		["Overkill-Restoration-StupidtyDownTitleID"] = "Temporizador Incapacitado Alfa",
		["Overkill-Restoration-StupidtyDownDescID"] = "Activa o desactiva el temporizador al ser incapacitado Alfa.",
		["Overkill-Restoration-StupidtyBagTitleID"] = "Panel De Bolsas Alfa",
		["Overkill-Restoration-StupidtyBagDescID"] = "Activa o desactiva el panel de Bolsas Alfa.",
		["Overkill-Restoration-StupidtyHostageTitleID"] = "Ocultar Panel De Rehenes",
		["Overkill-Restoration-StupidtyHostageDescID"] = "Si se activa, oculta el panel de rehenes cuando comienza un asalto, si la bandera de asalto o el indicador de alfa temprana están activados.",
		["Overkill-Restoration-StupidtyDifficultyMarkersTitleID"] = "Indicadores De Dificultad De Prelanzamiento",
		["Overkill-Restoration-StupidtyDifficultyMarkersDescID"] = "Activa o desactiva los Indicadores de Dificultad del Prelanzamiento.",
		["Overkill-Restoration-StupidtyStaminaIndicatorTitleID"] = "Indicador De Resistencia De Debug",
		["Overkill-Restoration-StupidtyStaminaIndicatorDescID"] = "Activa o desactiva el indicador de resistencia de Debug.",
		["Overkill-Restoration-StupidtyBlackScreenTitleID"] = "Pantalla Negra De Restoration",
		["Overkill-Restoration-StupidtyBlackScreenDescID"] = "Activar o desactivar la pantalla negra de Restoration Mod.",
		["Overkill-Restoration-StupidtyLoadoutsTitleID"] = "Equipos Alfa",
		["Overkill-Restoration-StupidtyLoadoutsDescID"] = "Activa o desactiva la pantalla de equipo Alfa.",
		["Overkill-Restoration-StupidtyDistrictTitleID"] = "Descripciones De Los Distritos De CRIME.NET",
		["Overkill-Restoration-StupidtyDistrictDescID"] = "Activar o desactivar las descripciones de los distritos en CRIME.NET.  No son exactas para el gameplay.",
		["Overkill-Restoration-StupidtySCOptionsButtonTitleID"] = "Opciones de Restoration Mod",
		["Overkill-Restoration-StupidtySCOptionsButtonDescID"] = "Opciones de Restoration Mod",
		["Overkill-Restoration-StupidtySCTitleID"] = "Modificación Completa (DEBUG)",
		["Overkill-Restoration-StupidtySCDescID"] = "Activa o desactiva la modificación completa de Restoration Mod. Si activas esta opción, saldrás automáticamente de la partida para evitar que se dañen los archivos guardados.",
		["Overkill-Restoration-StupidtyHolidayTitleID"] = "Efectos Festivos",
		["Overkill-Restoration-StupidtyHolidayDescID"] = "Activar o desactivar Efectos festivos para el Mod.",
		["Overkill-Restoration-StupidtyCloakerTurnTitleID"] = "Giro De Cámara Por Patada De Cloaker",
		["Overkill-Restoration-StupidtyCloakerTurnDescID"] = "Activa o desactiva el giro de cámara de Cloakers de Vanilla al recibir una patada de Cloaker.",
		["Overkill-Restoration-StupidtyDisableMutatorColorsTitleID"] = "Desactivar Colores Mutador Bandera Asalto",
		["Overkill-Restoration-StupidtyDisableMutatorColorsDescID"] = "Desactiva el cambio de color del estandarte de asalto al usar mutadores (solo HUD Vanilla).",
		...
		["Overkill-Restoration-StupidtyRestoreHitFlashTitleID"] = "Restaurar Destello De Golpe",
		["Overkill-Restoration-StupidtyRestoreHitFlashDescID"] = "Activa o desactiva el destello de golpe restaurado al recibir daño.",
		["Overkill-Restoration-StupidtyBotsNoDropTitleID"] = "Desactivar Lanzar Bolsas De Bots",
		["Overkill-Restoration-StupidtyBotsNoDropDescID"] = "Activa o desactiva que los bots puedan soltar bolsas de botín.",
		["Overkill-Restoration-StupidtyNotifyTitleID"] = "Notificación De Función",
		["Overkill-Restoration-StupidtyNotifyDescID"] = "Activa o desactiva la notificación de esta función.",
		["Overkill-Restoration-StupidtyPauseTitleID"] = "Menú De Pausa Alfa",
		["Overkill-Restoration-StupidtyPauseDescID"] = "Activar o desactivar el menú de pausa Alfa.",
		...
		["Overkill-Restoration-StupidtyColorOption"] = "Cambia el color de este elemento de la interfaz a tu gusto",
		["Overkill-Restoration-StupidtyColorsOptionsButtonTitleID"] = "Ajustes de color",
		["Overkill-Restoration-StupidtyColorsOptionsButtonDescID"] = "Cambiar el color de muchos objetos de la interfaz.",
		["Overkill-Restoration-StupidtyObjectivesBGTitleID"] = "Fondo de objetivos",
		["Overkill-Restoration-StupidtyObjectivesFGTitleID"] = "Primer plano de objetivos",
		["Overkill-Restoration-StupidtyAssaultBGTitleID"] = "Fondo de asalto",
		["Overkill-Restoration-StupidtyAssaultFGTitleID"] = "Primer plano de asalto",
		["Overkill-Restoration-StupidtyNoReturnTitleID"] = "Texto de punto de no retorno",
		["Overkill-Restoration-StupidtyTimerTextTitleID"] = "Texto de temporizador del atraco",
		["Overkill-Restoration-StupidtyAssaultEndlessBGTitleID"] = "Fondo de asalto de capitán",
		["Overkill-Restoration-StupidtyAssaultSurvivedBGTitleID"] = "Fondo de asalto sobrevivido",
		["Overkill-Restoration-StupidtyStaminaTitleID"] = "Resistencia",
		["Overkill-Restoration-StupidtyStaminaThresholdTitleID"] = "Umbral de resistencia", --Bob: No se donde aparece esto
		["Overkill-Restoration-StupidtyBagBitmapTitleID"] = "Bolsa",
		["Overkill-Restoration-StupidtyBagTextTitleID"] = "Texto de bolsa",
		["Overkill-Restoration-StupidtyNoReturnTextTitleID"] = "Texto de punto de no retorno",
		["Overkill-Restoration-StupidtyHostagesTextTitleID"] = "Texto de rehenes",
		["Overkill-Restoration-StupidtyHintTextTitleID"] = "Texto de pistas",
		["Overkill-Restoration-StupidtyMaskOnTextTitleID"] = "Texto de equipar máscara",
		["Overkill-Restoration-StupidtyDownsThreePlusTitleID"] = "Contador de vidas (3+ vidas restantes)",
		["Overkill-Restoration-StupidtyDownsTwoTitleID"] = "Contador de vidas (2 vidas restantes)",
		["Overkill-Restoration-StupidtyDownsOneTitleID"] = "Contador de vidas (1 vidas restantes)",
		["Overkill-Restoration-StupidtyDownsZeroTitleID"] = "Contador de vidas (0 vidas restantes)",
		["Overkill-Restoration-StupidtyStopAllBotsTitleID"] = "Detener a todos los bots",
		["Overkill-Restoration-StupidtyStopAllBotsDescID"] = "Detiene a todos los miembros del equipo controlados por la IA manteniendo pulsada la tecla Detener IA.",
		["Overkill-Restoration-StupidtyPONRTrackTitleID"] = "Música De Punto De No Retorno",
		["Overkill-Restoration-StupidtyPONRTrackDescID"] = "Cambia la banda sonora en Trabajos Pro cuando comience el punto de no retorno.",
		["Overkill-Restoration-StupidtyPONRTracksTitleID"] = "Música De Punto De No Retorno",
		["Overkill-Restoration-StupidtyPONRTracksDescID"] = "Selecciona la banda sonora para Trabajos Pro cuando comience el punto de no retorno.",
		["Overkill-Restoration-StupidtyMusicShuffleTitleID"] = "Música Aleatoria",
		["Overkill-Restoration-StupidtyMusicShuffleDescID"] = "Cambia la banda sonora al terminar un asalto.",
		...
		["Overkill-Restoration-StupidtyScaleTitleID"] = "Escala de la interfaz",
		["Overkill-Restoration-StupidtyScaleDescID"] = "Cambia la escala de la interfaz. Puede requerir un reinicio.",
		["Overkill-Restoration-StupidtySizeOnScreenTitleID"] = "Tamaño de la interfaz en la pantalla",
		["Overkill-Restoration-StupidtySizeOnScreenDescID"] = "Cambia el tamaño de la interfaz en la pantalla. Puede requerir un reinicio.",
		["Overkill-Restoration-StupidtyTeammateTitleID"] = "Panel de compañeros Alfa",
		["Overkill-Restoration-StupidtyTeammateDescID"] = "Activar o desactivar el panel de compañeros de equipo Alfa, que muestra tus estadísticas y las de tu equipo.",
		["Overkill-Restoration-StupidtyHeistTimerTitleID"] = "Temporizador de atraco Alfa.",
		["Overkill-Restoration-StupidtyHeistTimerDescID"] = "Activar o desactivar el temporizador de atraco Alfa.",
		["Overkill-Restoration-StupidtyMaskOnTitleID"] = "Texto para equipar máscara Alfa",
		["Overkill-Restoration-StupidtyMaskOnDescID"] = "Activar o desactivar texto para equipar máscara Alfa.",
		["Overkill-Restoration-StupidtyNameLabelsTitleID"] = "Etiquetas de nombre Alfa", --Bob: Probablemente se puede usar otro termino en vez de etiquetas
		["Overkill-Restoration-StupidtyNameLabelsDescID"] = "Activar o desactivar las etiquetas de nombre alfa.",
		["Overkill-Restoration-StupidtyHintTitleID"] = "Panel de pistas Alfa",
		["Overkill-Restoration-StupidtyHintDescID"] = "Activar o desactivar el panel de pistas alfa.",
		["Overkill-Restoration-StupidtyExtraOptionsButtonTitleID"] = "Más opciones de interfaz",
		["Overkill-Restoration-StupidtyExtraOptionsButtonDescID"] = "¡Aún más opciones!",
		["Overkill-Restoration-StupidtyRealAmmoTitleID"] = "Munición Real",
		["Overkill-Restoration-StupidtyRealAmmoDescID"] = "El contador de munición total ignora la munición que hay actualmente en tu arma.",
		["Overkill-Restoration-StupidtyStealthOrigPosTitleID"] = "Posicionamiento Medidor De Detección Base",
		["Overkill-Restoration-StupidtyStealthOrigPosDescID"] = "Coloca el medidor de detección en la misma zona que el juego base.",
		["Overkill-Restoration-StupidtyLowerBagTitleID"] = "Notificación de bolsa más baja",
		["Overkill-Restoration-StupidtyLowerBagDescID"] = "Baja la alerta que aparece al tomar una bolsa.",
		["Overkill-Restoration-StupidtyAssaultStyleTitleID"] = "Estilo Panel Asalto",
		["Overkill-Restoration-StupidtyAssaultStyleDescID"] = "Permite elegir el estilo de panel de asalto que quieras utilizar.",
		["Overkill-Restoration-StupidtyCasingTickerTitleID"] = "Texto De Modo Observador Alfa",
		["Overkill-Restoration-StupidtyCasingTickerDescID"] = "Activar o desactivar texto de modo Observador Alfa (Requiere estilo de cinta Alfa).",
		["Overkill-Restoration-StupidtyCustodyTitleID"] = "Custodia Alfa",
		["Overkill-Restoration-StupidtyCustodyDescID"] = "Activar o desactivar el panel de custodia alfa.",
		["Overkill-Restoration-StupidtyCrimenetTitleID"] = "CRIMENET Alfa (NO TERMINADO)",
		["Overkill-Restoration-StupidtyCrimenetDescID"] = "Activar o desactivar CRIMENET alfa.",
		["Overkill-Restoration-StupidtyProfileTitleID"] = "Marco De Perfil Alfa",
		["Overkill-Restoration-StupidtyProfileDescID"] = "Activar o desactivar el marco de perfil alfa.",
		["Overkill-Restoration-StupidtyNewsfeedTitleID"] = "Noticias Alfa",
		["Overkill-Restoration-StupidtyNewsfeedDescID"] = "Activar o desactivar Noticias alfa.",
		["Overkill-Restoration-StupidtyUppercaseNamesTitleID"] = "Nombres En Mayúsculas",
		["Overkill-Restoration-StupidtyUppercaseNamesDescID"] = "Activar o desactivar los nombres en mayúsculas.",
		["Overkill-Restoration-StupidtyPeerColorsTitleID"] = "Colores Pares Alfa",
		["Overkill-Restoration-StupidtyPeerColorsDescID"] = "Activa o desactiva los colores alfa.", --Bob: No se a que se refiere con esta opcion
		["Overkill-Restoration-StupidtyPocoCrimenetAlignSortTitleID"] = "Alinear y ordenar CRIMENET de Poco", --Bob: Esto se refiere al poco hud?
		["Overkill-Restoration-StupidtyPocoCrimenetAlignSortDescID"] = "Alinea y ordena CRIMENET por dificultad.",
		["Overkill-Restoration-StupidtyPocoCrimenetScaleTitleID"] = "Escala de CRIMENET de Poco", --Bob: Esto se refiere al poco hud?
		["Overkill-Restoration-StupidtyPocoCrimenetScaleDescID"] = "Permite ajustar la escala de CRIMENET.",
		...
		["Overkill-Restoration-StupidtyVoiceIconTitleID"] = "Icono De Chat De Voz",
	    ["Overkill-Restoration-StupidtyVoiceIconDescID"] = "Mostrar cuando un jugador está usando el chat de voz dentro del juego.",
		["Overkill-Restoration-StupidtyNewsFeedStyleTitleID"] = "Estilo Alfa De Noticias", --Bob: Comprobar si newsfeed tiene otro nombre
		["Overkill-Restoration-StupidtyNewsFeedStyleDescID"] = "Te permite elegir entre mostrar las noticias y los nuevos trabajos o sólo las noticias.",
		...
		["Overkill-Restoration-StupidtyDodgeDisplayTitleID"] = "Medidor de Esquiva",
		["Overkill-Restoration-StupidtyDodgeDisplayDescID"] = "Cambia lo que *muestra* el valor máximo del medidor de esquiva. Requiere reinicio.",
		...
		["Overkill-Restoration-StupidtyPDTHChallengesTitleID"] = "Mostrar desafíos PD:TH",
		["Overkill-Restoration-StupidtyPDTHChallengesDescID"] = "Alterna la visibilidad de los desafíos PD:TH en el menú y en el hud.",

		["Overkill-Restoration-StupidtyRaidLockPickingTitleID"] = "Modificar Ganzúas",
		["Overkill-Restoration-StupidtyRaidLockPickingDescID"] = "¿Debería el mod modificar las ganzúas? Esto cambia la jugabilidad en torno a forzar cerraduras",
		["Overkill-Restoration-StupidtyRaidLockPickingVOTitleID"] = "Reproducir Líneas De Voz",
		["Overkill-Restoration-StupidtyRaidLockPickingVODescID"] = "¿Debería el mod reproducir líneas de voz al forzar cerraduras?",
		...
		["Overkill-Restoration-StupidtyArmorFixTitleID"] = "Arreglo De Parpadeo Del Blindaje",
		["Overkill-Restoration-StupidtyArmorFixDescID"] = "Habilitar o deshabilitar el parpadeo del blindaje.",
