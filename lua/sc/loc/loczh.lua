...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
    LocalizationManager:add_localized_strings({
        ...
        ["Overkill-Restoration-StupidtyOptionsButtonTitleID"] = "恢复MOD设置",
        ["Overkill-Restoration-StupidtyOptionsButtonDescID"] = "恢复MOD的设置",
        ["Overkill-Restoration-StupidtyHUDOptionsButtonTitleID"] = "恢复HUD和UI设置",
        ["Overkill-Restoration-StupidtyHUDOptionsButtonDescID"] = "设置恢复MOD的HUD和UI界面",
        ["Overkill-Restoration-StupidtyOTHEROptionsButtonTitleID"] = "其它设置",
        ["Overkill-Restoration-StupidtyOTHEROptionsButtonDescID"] = "设置额外的功能",
        ["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonTitleID"] = "(+) 武器使用习惯设置",
        ["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonDescID"] = "内含有关你武器使用习惯的设置。\n包含瞄准习惯、操作习惯等。",
        ["Overkill-Restoration-StupidtyUIOptionsButtonTitleID"] = "Alpha UI",
        ["Overkill-Restoration-StupidtyUIOptionsButtonDescID"] = "Alpha UI的设置",
        ["Overkill-Restoration-StupidtyTimeOfDayTitleID"] = "自定义劫案时间",
        ["Overkill-Restoration-StupidtyTimeOfDayDescID"] = "你可以自定义劫案一天的时间，该项也添加了新的劫案时间",

        ["restoration_level_data_unknown"] = "时间未知，地点未知",
        ["Overkill-Restoration-StupidtyEnv_BanksTitleID"] = "丰信银行",
        ["Overkill-Restoration-StupidtyEnv_BanksDescID"] = "为 银行劫案 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_RVD1TitleID"] = "落水狗劫案 Day 1",
        ["Overkill-Restoration-StupidtyEnv_RVD1DescID"] = "为 落水狗劫案 第一天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_RVD2TitleID"] = "落水狗劫案 Day 2",
        ["Overkill-Restoration-StupidtyEnv_RVD2DescID"] = "为 落水狗劫案 第二天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_FSD1TitleID"] = "纵火者 Day 1",
        ["Overkill-Restoration-StupidtyEnv_FSD1DescID"] = "为 纵火者 第一天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_PBR2TitleID"] = "天之诞辰",
        ["Overkill-Restoration-StupidtyEnv_PBR2DescID"] = "为 天之诞辰 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_CJ2TitleID"] = "炸弹劫案: 船坞",
        ["Overkill-Restoration-StupidtyEnv_CJ2DescID"] = "为 炸弹劫案: 船坞 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_UnderPassTitleID"] = "武装押运: 地下通道",
        ["Overkill-Restoration-StupidtyEnv_UnderPassDescID"] = "为 武装押运: 地下通道 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_MallCrasherTitleID"] = "商城拆迁队",
        ["Overkill-Restoration-StupidtyEnv_MallCrasherDescID"] = "为 商城拆迁队 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_Mia_1TitleID"] = "火线迈阿密 Day 1",
        ["Overkill-Restoration-StupidtyEnv_Mia_1DescID"] = "为 迈阿密热线 第一天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_FSD3TitleID"] = "纵火者 Day 3",
        ["Overkill-Restoration-StupidtyEnv_FSD3DescID"] = "为 纵火者 第三天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_WDD1NTitleID"] = "看门狗 Day 1 (夜晚)",
        ["Overkill-Restoration-StupidtyEnv_WDD1NDescID"] = "为 看门狗 第一天 (夜晚) 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_WDD1DTitleID"] = "看门狗 Day 1 (白天)",
        ["Overkill-Restoration-StupidtyEnv_WDD1DDescID"] = "为 看门狗 第一天 (白天) 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_WDD2DTitleID"] = "看门狗 Day 2 (白天)",
        ["Overkill-Restoration-StupidtyEnv_WDD2DDescID"] = "为 看门狗 第二天 (白天) 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_Alex3TitleID"] = "鼠辈 Day 3",
        ["Overkill-Restoration-StupidtyEnv_Alex3DescID"] = "为 鼠辈 第三天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_BigTitleID"] = "大银行",
        ["Overkill-Restoration-StupidtyEnv_BigDescID"] = "为 大银行 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_FSTitleID"] = "四家商店",
        ["Overkill-Restoration-StupidtyEnv_FSDescID"] = "为 四家商店 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_UkraTitleID"] = "乌克兰劫案",
        ["Overkill-Restoration-StupidtyEnv_UkraDescID"] = "为 乌克兰劫案 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_KosugiTitleID"] = "暗影突袭",
        ["Overkill-Restoration-StupidtyEnv_KosugiDescID"] = "为 暗影突袭 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_PetaTitleID"] = "模拟山羊 Day 1",
        ["Overkill-Restoration-StupidtyEnv_PetaDescID"] = "为 模拟山羊 第一天 选择一种环境",
        ["Overkill-Restoration-StupidtyEnv_FRIENDTitleID"] = "疤面山庄",
        ["Overkill-Restoration-StupidtyEnv_FRIENDDescID"] = "为 疤面山庄 选择一种环境",
        ["Overkill-Restoration-StupidtyINFOHUDOptionsButtonTitleID"] = "Buff追踪器",
        ["Overkill-Restoration-StupidtyINFOHUDOptionsButtonDescID"] = "在屏幕左侧显示当前技能及其具体信息数据。不需要启用 Alpha UI。",
        ["Overkill-Restoration-StupidtyInfo_HudTitleID"] = "启用 Buff追踪器",
        ["Overkill-Restoration-StupidtyInfo_HudDescID"] = "启用或停用 Buff追踪器 的UI界面",
        ["Overkill-Restoration-StupidtyInfo_SizeTitleID"] = "图标大小",
        ["Overkill-Restoration-StupidtyInfo_SizeDescID"] = "控制 Buff追踪器 图标的大小",
        ["Overkill-Restoration-StupidtyInfo_CountTitleID"] = "每行技能数量",
        ["Overkill-Restoration-StupidtyInfo_CountDescID"] = "控制每行显示多少个技能及其图标",
        ["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadTitleID"] = "迅猛装填",
        ["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_ammo_efficiencyTitleID"] = "弹无虚发",
        ["Overkill-Restoration-StupidtyInfo_ammo_efficiencyDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedTitleID"] = "血之渴望",
        ["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_bullet_stormTitleID"] = "子弹风暴",
        ["Overkill-Restoration-StupidtyInfo_bullet_stormDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_revive_damage_reductionTitleID"] = "医疗兵",
        ["Overkill-Restoration-StupidtyInfo_revive_damage_reductionDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_desperadoTitleID"] = "亡命之徒",
        ["Overkill-Restoration-StupidtyInfo_desperadoDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_grinderTitleID"] = "组织胺 (冰球手)",
        ["Overkill-Restoration-StupidtyInfo_grinderDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_infiltratorTitleID"] = "生命汲取 (渗透者)",
        ["Overkill-Restoration-StupidtyInfo_infiltratorDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_sociopathTitleID"] = "危急情形 (反社会者)",
        ["Overkill-Restoration-StupidtyInfo_sociopathDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_body_expertiseTitleID"] = "血花四溅", --人体解析
        ["Overkill-Restoration-StupidtyInfo_body_expertiseDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_long_dis_reviveTitleID"] = "领袖鼓舞",
        ["Overkill-Restoration-StupidtyInfo_long_dis_reviveDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_messiahTitleID"] = "弥赛亚",
        ["Overkill-Restoration-StupidtyInfo_messiahDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierTitleID"] = "疯狂杀戮",
        ["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_revived_damage_reductionTitleID"] = "止疼药",
        ["Overkill-Restoration-StupidtyInfo_revived_damage_reductionDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionTitleID"] = "快速包扎",
        ["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_rogueTitleID"] = "杀手本能 (浪人)",
        ["Overkill-Restoration-StupidtyInfo_rogueDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_increased_movement_speedTitleID"] = "死里逃生",
        ["Overkill-Restoration-StupidtyInfo_increased_movement_speedDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multTitleID"] = "神枪手",
        ["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_trigger_happyTitleID"] = "乱枪狂人",
        ["Overkill-Restoration-StupidtyInfo_trigger_happyDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedTitleID"] = "落水狗",
        ["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_unseen_strikeTitleID"] = "掩其无备",
        ["Overkill-Restoration-StupidtyInfo_unseen_strikeDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_survive_one_hitTitleID"] = "鬼之刺青 (极道)",
        ["Overkill-Restoration-StupidtyInfo_survive_one_hitDescID"] = "开启或关闭对此技能的追踪",
        ["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenTitleID"] = "医疗箱血量恢复",
        ["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenDescID"] = "开启或关闭对医疗箱血量恢复剩余时间的追踪",
        ["Overkill-Restoration-StupidtyAltLastDownColorTitleID"] = "更改被逮捕前最后一次倒地的颜色",
        ["Overkill-Restoration-StupidtyAltLastDownColorDescID"] = "将被逮捕前最后一次倒地时角色边框的颜色设置为 color_sin_classic*.",
        ["Overkill-Restoration-StupidtyNoBleedoutTiltTitleID"] = "取消倒地视角的倾斜",
        ["Overkill-Restoration-StupidtyNoBleedoutTiltDescID"] = "倒地后玩家的视角将不再倾斜",
        ["Overkill-Restoration-StupidtyGOTTAGETAGRIPTitleID"] = "Hide ALL Foregrips",  --tra
        ...
        ["Overkill-Restoration-StupidtyADSTransitionStyleTitleID"] = "瞄准风格",
        ["Overkill-Restoration-StupidtyADSTransitionStyleDescID"] = "改变你使用瞄准的动作风格。",
        ["Overkill-Restoration-StupidtyGCGPYPMMSACTitleID"] = "禁用星战武器", -- may need improved
        ["Overkill-Restoration-StupidtyGCGPYPMMSACDescID"] = "关闭来自遥远银河系的武器配件及其机制。\n重启劫案生效。", -- may need improved
        ["Overkill-Restoration-StupidtyGCGPYPMMSACTextTitleID"] = "禁用彩蛋文本",
        ["Overkill-Restoration-StupidtyGCGPYPMMSACTextDescID"] = "关闭极低概率出现的彩蛋文本。\n重启劫案生效。",
        ["Overkill-Restoration-StupidtyForceEggsOptionsButtonTitleID"] = "强制使用彩蛋文本",
        ["Overkill-Restoration-StupidtyForceEggsOptionsButtonDescID"] = "无视禁用，强制显示彩蛋文本。\n重启劫案生效。",
            ["Overkill-Restoration-StupidtyUpotteTitleID"] = "游戏的梗",  --eggplant
            ["Overkill-Restoration-StupidtyUpotteDescID"] = "原友觉醒！\n有关三国杀、守望先锋、战地、原神、CF、CSGO、Apex等游戏的梗。",
            ...
            ["Overkill-Restoration-StupidtyCrabBattleTitleID"] = "国外的梗",  --bobcat
            ["Overkill-Restoration-StupidtyCrabBattleDescID"] = "左轮山猫",
            ["Overkill-Restoration-StupidtyEmberMyBelovedTitleID"] = "鹰姐的梗",  --registeredloser
            ["Overkill-Restoration-StupidtyEmberMyBelovedDescID"] = "鹰姐自己写的一些难登大雅之堂但是似乎有趣甚至是有用的梗。",
            ["Overkill-Restoration-StupidtyBigManTitleID"] = "其它梗:^)",  --shitpost
            ["Overkill-Restoration-StupidtyBigManDescID"] = "其它难以分类的梗。",
        ["Overkill-Restoration-StupidtyStaticAimTitleID"] = "瞄准时武器无变向",
        ["Overkill-Restoration-StupidtyStaticAimDescID"] = "勾选以关闭你在瞄准时，武器会随着你屏幕的移动而变向的效果，参考PDTH。会替换Viewmodel Movement的效果。\n重启以生效。警告：取消勾选将导致某些选项不可用。",
        ["Overkill-Restoration-StupidtyViewmodelMovementTitleID"] = "武器模型运动效果", -- tra
        ["Overkill-Restoration-StupidtyViewmodelMovementDescID"] = "在此设置你的武器模型在你视角移动时如何运动。\n瞄准时的效果会被\"瞄准时武器无变向\"设置覆盖。重启以生效。",
        ["vm_vanilla"] = "同原版",
        ["vm_drag"] = "武器延后移动",
        ["vm_lead"] = "武器先于移动",
        ["vm_static"] = "静止（无动作）",
        ["Overkill-Restoration-StupidtyCarpalTunnelTitleID"] = "自动压枪",
        ["Overkill-Restoration-StupidtyCarpalTunnelDescID"] = "选择原版中自动压枪机制的效果程度。\n即在完成射击后，准星会自动下移一部分后坐力抬升的角度。",
        ["Overkill-Restoration-StupidtyWpnCatTitleID"] = "购买菜单分类方式",
        ["Overkill-Restoration-StupidtyWpnCatDescID"] = "改变武器在购买菜单的分类方式。重启游戏生效。",
        ["Overkill-Restoration-StupidtyAutoDMRsTitleID"] = "DMR步枪全自动模式开局",
        ["Overkill-Restoration-StupidtyAutoDMRsDescID"] = "选择是否让所有可调节射击模式的精确射手步枪以全自动射击模式开局。",
        ["Overkill-Restoration-StupidtySprintCancelTitleID"] = "紧急回避专精起跑打断换弹",
        ["Overkill-Restoration-StupidtySprintCancelDescID"] = "选择在你专精了\"紧急回避\"技能后，跑步是否会打断换弹。\n勾选以打断换弹来应对按R召唤敌人的情况。",
        ["Overkill-Restoration-StupidtySevenHoldTitleID"] = "轻按互动切换 (Press2Hold)",
        ["Overkill-Restoration-StupidtySevenHoldDescID"] = "只需要按一下互动键，就会自动保持互动。\n再按一次互动键取消互动。",
        ["Overkill-Restoration-StupidtySevenHoldDeployCancelTitleID"] = "用放置随身装备键取消互动",
        ["Overkill-Restoration-StupidtySevenHoldDeployCancelDescID"] = "勾选以使用放置随身装备的按键取消互动。需要先开启轻按互动切换。",
        ["Overkill-Restoration-StupidtyQueuedShootingTitleID"] = "连点射击辅助输入",
        ["Overkill-Restoration-StupidtyQueuedShootingDescID"] = "半自动武器在连续点鼠标两下时，可能因为射击间隔还没到，第二发没射出来。\n勾选此选项帮助你在射击间隔期间按鼠标也会等待间隔结束自动帮你开火。",
        ["Overkill-Restoration-StupidtyQueuedShootingWindowTitleID"] = "单发辅助输入的灵敏度",
        ["Overkill-Restoration-StupidtyQueuedShootingWindowDescID"] = "以百分比决定你在间隔达到之前什么时候点鼠标可以让下一发射出来，值高意味着更早。\n例：3秒间隔+0.2值=射击后等2.4秒再点鼠标就会让第二发在又0.6秒后自动射出来",
        ["Overkill-Restoration-StupidtyQueuedShootingExcludeTitleID"] = "单发辅助输入的武器限制",
        ["Overkill-Restoration-StupidtyQueuedShootingExcludeDescID"] = "只为高于此选项所设射速(RPM)的武器启用辅助输入。",
        ["Overkill-Restoration-StupidtyQueuedShootingMidBurstTitleID"] = "速射辅助输入",--Burstfire Mid-Burst Input Buffer",
        ["Overkill-Restoration-StupidtyQueuedShootingMidBurstDescID"] = "Buffer fire inputs made *during* a burst.", --tra
        ...
        ["Overkill-Restoration-StupidtyNoADSRecoilAnimsTitleID"] = "取消瞄准后坐力动作",
        ["Overkill-Restoration-StupidtyNoADSRecoilAnimsDescID"] = "勾选以取消你在瞄准时射击产生的后坐力动画。\n有些武器不受此选项影响（换言之即手动操作的枪械，弓弩，火焰喷射器）",
        ["Overkill-Restoration-StupidtyNoSwapOnReviveTitleID"] = "被救起时不强制切换武器",
        ["Overkill-Restoration-StupidtyNoSwapOnReviveDescID"] = "勾选以避免在“苟延残喘”技能未专精且使用主武器倒地时，\n被救起后强行切换出主武器。",
        ["Overkill-Restoration-StupidtyManualReloadsTitleID"] = "手动换弹",
        ["Overkill-Restoration-StupidtyManualReloadsDescID"] = "禁止在弹匣打空时自动换弹。",
        ["Overkill-Restoration-StupidtySecondSightSprintTitleID"] = "使用冲刺按键切换次要瞄具",
        ["Overkill-Restoration-StupidtySecondSightSprintDescID"] = "使用冲刺按键而不是附件按键来在瞄准时切换为次要瞄具。\n这将导致你无法在瞄准时即刻切换为奔跑状态。", -- try
        ["Overkill-Restoration-StupidtyAimDeploysBipodTitleID"] = "瞄准时自动用脚架",
        ["Overkill-Restoration-StupidtyAimDeploysBipodDescID"] = "勾选以在一个可用平面瞄准时自动架起脚架。",
        ["Overkill-Restoration-StupidtyMoveCancelBipodTitleID"] = "移动时自动收脚架",
        ["Overkill-Restoration-StupidtyMoveCancelBipodDescID"] = "勾选以在你移动时自动收起脚架。",
        ["Overkill-Restoration-StupidtySeparateBowADSTitleID"] = "分离弓的瞄准",
        ["Overkill-Restoration-StupidtySeparateBowADSDescID"] = "勾选以关闭拉弓时强制进入瞄准状态。\n启用后，你的换弹按键将用于停止拉弓。",
        ["Overkill-Restoration-StupidtyClassicMoviesTitleID"] = "PD:TH经典界面",
        ["Overkill-Restoration-StupidtyClassicMoviesDescID"] = "选择是否在任务简报界面采用PD:TH的经典页面(仅适用于经典劫案)",
        ["Overkill-Restoration-StupidtyPerPelletShotgunsTitleID"] = "Per-Pellet Shotgun Damage (WIP)", -- tra
        ["Overkill-Restoration-StupidtyPerPelletShotgunsDescID"] = "Shotgun damage is calculated per pellet as opposed to the standard \"1 pellet = full damage, headshots prioritized\". Non-slug shotgun damage is increased to compesate for lower consistency. Requires restart.",

        -- not anymore?(non-note)
        ["Overkill-Restoration-StupidtyQuietRainTitleID"] = "减轻雨声",
        ["Overkill-Restoration-StupidtyQuietRainDescID"] = "在下雨的劫案中雨声不会那么嘈杂",
        ...
        ["Overkill-Restoration-StupidtyWepNamesTitleID"] = "武器名称显示方式",
        ["Overkill-Restoration-StupidtyWepNamesDescID"] = "改变武器名字的显示风格。\n重启以生效。",
        ...
        ["Overkill-Restoration-StupidtyPaintingsTitleID"] = "生成未被使用的画",
        ["Overkill-Restoration-StupidtyPaintingsDescID"] = "允许或禁止在 美术馆-画廊 中生成原版未被使用的画作。仅作为房主时有效。",
        ["Overkill-Restoration-StupidtyMainHUDTitleID"] = "启用 Alpha HUD",
        ["Overkill-Restoration-StupidtyMainHUDDescID"] = "完全启用或停用 Alpha HUD",
        ["Overkill-Restoration-StupidtyWaypointsTitleID"] = "Alpha路径点",
        ["Overkill-Restoration-StupidtyWaypointsDescID"] = "启用或停用 Alpha路径点",
        ["Overkill-Restoration-StupidtyAssaultPanelTitleID"] = "Alpha突击横幅",
        ["Overkill-Restoration-StupidtyAssaultPanelDescID"] = "启用或停用贴条形的 Alpha突击横幅",
        ["Overkill-Restoration-StupidtyAltAssaultTitleID"] = "早期Alpha突击指示器",
        ["Overkill-Restoration-StupidtyAltAssaultDescID"] = "启用或停用早期的 \"Alpha突击指示器\" 以替换 \"突击横幅\"",
        ["Overkill-Restoration-StupidtyObjectivesPanelTitleID"] = "Alpha 任务指示器",
        ["Overkill-Restoration-StupidtyObjectivesPanelDescID"] = "启用或停用 Alpha任务指示器",
        ["Overkill-Restoration-StupidtyPresenterTitleID"] = "Alpha 提示框",
        ["Overkill-Restoration-StupidtyPresenterDescID"] = "启用或停用 Alpha提示框，提示框用于显示新的任务目标和劫获的战利品",
        ["Overkill-Restoration-StupidtyInteractionTitleID"] = "Alpha 互动圈",
        ["Overkill-Restoration-StupidtyInteractionDescID"] = "启用或停用 Alpha互动圈",
        ["Overkill-Restoration-StupidtyStealthTitleID"] = "Alpha 警戒条",
        ["Overkill-Restoration-StupidtyStealthDescID"] = "启用或停用 Alpha潜入警戒条",
        ["Overkill-Restoration-StupidtyDownTitleID"] = "Alpha 倒地计时器",
        ["Overkill-Restoration-StupidtyDownDescID"] = "启用或停用 Alpha倒地计时器",
        ["Overkill-Restoration-StupidtyBagTitleID"] = "Alpha 战利品面板",
        ["Overkill-Restoration-StupidtyBagDescID"] = "启用或停用 Alpha战利品面板",
        ["Overkill-Restoration-StupidtyHostageTitleID"] = "隐藏人质面板",
        ["Overkill-Restoration-StupidtyHostageDescID"] = "如果选中，人质面板会在警方突击开始时被隐藏，只在选中突击横幅或突击指示器时有效",
        ["Overkill-Restoration-StupidtyDifficultyMarkersTitleID"] = "测试版难度指示器",
        ["Overkill-Restoration-StupidtyDifficultyMarkersDescID"] = "启用或停用 测试版难度指示器",
        ["Overkill-Restoration-StupidtyStaminaIndicatorTitleID"] = "Debug耐力指示器",
        ["Overkill-Restoration-StupidtyStaminaIndicatorDescID"] = "启用或禁用 Debug耐力指示器",
        ["Overkill-Restoration-StupidtyBlackScreenTitleID"] = "恢复Mod黑屏界面",
        ["Overkill-Restoration-StupidtyBlackScreenDescID"] = "启用或禁用 恢复Mod黑屏界面",
        ["Overkill-Restoration-StupidtyLoadoutsTitleID"] = "Alpha 简报界面",
        ["Overkill-Restoration-StupidtyLoadoutsDescID"] = "启用或停用 Alpha简报界面",
        ["Overkill-Restoration-StupidtyDistrictTitleID"] = "CRIME.NET地区详情",
        ["Overkill-Restoration-StupidtyDistrictDescID"] = "启用或禁用 CRIME.NET上地区的详情。也许与游戏描述不相符。",
        ["Overkill-Restoration-StupidtySCOptionsButtonTitleID"] = "恢复大修设置",
        ["Overkill-Restoration-StupidtySCOptionsButtonDescID"] = "恢复MOD的大修的设置",
        ["Overkill-Restoration-StupidtySCTitleID"] = "完全大修(DEBUG)",
        ["Overkill-Restoration-StupidtySCDescID"] = "启用或禁用恢复mod的完全游戏更改。切换此选项将自动退出游戏，以防止存档损坏。",
        ["Overkill-Restoration-StupidtyHolidayTitleID"] = "节日活动",
        ["Overkill-Restoration-StupidtyHolidayDescID"] = "开启或关闭 节日活动 对大修的影响",
        ["Overkill-Restoration-StupidtyCloakerTurnTitleID"] = "幻影特工飞踢时视角转向",
        ["Overkill-Restoration-StupidtyCloakerTurnDescID"] = "开启或关闭幻影特工飞踢你时，你的视角自动转向它的效果。",
        ["Overkill-Restoration-StupidtyDisableMutatorColorsTitleID"] = "Disable Mutator Assault Banner Colors", --tra
        ["Overkill-Restoration-StupidtyDisableMutatorColorsDescID"] = "Disable the color change to the Assault Banner when using mutators (仅用于Vanilla HUD).",
		...
		["Overkill-Restoration-StupidtyRestoreHitFlashTitleID"] = "恢复Mod受击闪屏",
        ["Overkill-Restoration-StupidtyRestoreHitFlashDescID"] = "启用或禁用恢复Mod的受击闪屏",
        ["Overkill-Restoration-StupidtyBotsNoDropTitleID"] = "禁用Bot队友丢包",
        ["Overkill-Restoration-StupidtyBotsNoDropDescID"] = "勾选以禁止AI队友在任何情况下丢掉身上的包",
        ["Overkill-Restoration-StupidtyNotifyTitleID"] = "功能及特色提示",
        ["Overkill-Restoration-StupidtyNotifyDescID"] = "启用或禁用对模组特色的通知和提示",
        ["Overkill-Restoration-StupidtyPauseTitleID"] = "Alpha 暂停菜单",
        ["Overkill-Restoration-StupidtyPauseDescID"] = "启用或停用 Alpha暂停菜单",
        ...
        ["Overkill-Restoration-StupidtyColorOption"] = "根据您的偏好设置HUD各对象的颜色",
        ["Overkill-Restoration-StupidtyColorsOptionsButtonTitleID"] = "颜色设置",
        ["Overkill-Restoration-StupidtyColorsOptionsButtonDescID"] = "设置HUD各对象的颜色",
        ["Overkill-Restoration-StupidtyObjectivesBGTitleID"] = "任务指示器背景颜色",
        ["Overkill-Restoration-StupidtyObjectivesFGTitleID"] = "任务指示器字体颜色",
        ["Overkill-Restoration-StupidtyAssaultBGTitleID"] = "突击横幅背景颜色",
        ["Overkill-Restoration-StupidtyAssaultFGTitleID"] = "突击横幅字体颜色",
        ["Overkill-Restoration-StupidtyNoReturnTitleID"] = "任务即将失败字体颜色",
        ["Overkill-Restoration-StupidtyTimerTextTitleID"] = "劫案计时器字体颜色",
        ["Overkill-Restoration-StupidtyAssaultEndlessBGTitleID"] = "队长突击横幅背景颜色",
        ["Overkill-Restoration-StupidtyAssaultSurvivedBGTitleID"] = "突击存活横幅背景颜色",
        ["Overkill-Restoration-StupidtyStaminaTitleID"] = "耐力指示器颜色",
        ["Overkill-Restoration-StupidtyStaminaThresholdTitleID"] = "奔跑耐力下限",
        ["Overkill-Restoration-StupidtyBagBitmapTitleID"] = "包图形颜色",
        ["Overkill-Restoration-StupidtyBagTextTitleID"] = "包字体颜色",
        ["Overkill-Restoration-StupidtyNoReturnTextTitleID"] = "任务即将失败字体颜色",
        ["Overkill-Restoration-StupidtyHostagesTextTitleID"] = "人质数量颜色",
        ["Overkill-Restoration-StupidtyHintTextTitleID"] = "提示字体颜色",
        ["Overkill-Restoration-StupidtyMaskOnTextTitleID"] = "佩戴面具字体颜色",
        ["Overkill-Restoration-StupidtyDownsThreePlusTitleID"] = "倒地计数器（剩余3+倒地次数）",
        ["Overkill-Restoration-StupidtyDownsTwoTitleID"] = "倒地计数器（剩余2次）",
        ["Overkill-Restoration-StupidtyDownsOneTitleID"] = "倒地计数器（剩余1次）",
        ["Overkill-Restoration-StupidtyDownsZeroTitleID"] = "倒地计数器（剩余0次）",
        ["Overkill-Restoration-StupidtyStopAllBotsTitleID"] = "停下全部AI",
        ["Overkill-Restoration-StupidtyStopAllBotsDescID"] = "长按AI停止键以停下全部AI。",
        ["Overkill-Restoration-StupidtyPONRTrackTitleID"] = "任务即将失败音乐",
        ["Overkill-Restoration-StupidtyPONRTrackDescID"] = "改变当任务即将失败开始时专业劫案的音乐。",
        ["Overkill-Restoration-StupidtyPONRTracksTitleID"] = "任务即将失败音乐",
        ["Overkill-Restoration-StupidtyPONRTracksDescID"] = "选择当任务即将失败开始时专业劫案的音乐。",
        ["Overkill-Restoration-StupidtyMusicShuffleTitleID"] = "音乐切换",
        ["Overkill-Restoration-StupidtyMusicShuffleDescID"] = "突击结束后切换音乐。",
        ...
        ["Overkill-Restoration-StupidtyScaleTitleID"] = "HUD缩放",
        ["Overkill-Restoration-StupidtyScaleDescID"] = "调整HUD缩放。可能需要重新开始劫案才能生效。",
        ["Overkill-Restoration-StupidtySizeOnScreenTitleID"] = "HUD屏幕中大小",
        ["Overkill-Restoration-StupidtySizeOnScreenDescID"] = "调整HUD于屏幕中大小。可能需要重新开始劫案才能生效。",
        ["Overkill-Restoration-StupidtyTeammateTitleID"] = "alpha队友面板",
        ["Overkill-Restoration-StupidtyTeammateDescID"] = "开启或关闭显示你与你的小队的统计数据的alpha队友面板。",
        ["Overkill-Restoration-StupidtyHeistTimerTitleID"] = "alpha劫案计时器",
        ["Overkill-Restoration-StupidtyHeistTimerDescID"] = "开启或关闭alpha劫案计时器。",
        ["Overkill-Restoration-StupidtyMaskOnTitleID"] = "alpha佩戴面具文字",
        ["Overkill-Restoration-StupidtyMaskOnDescID"] = "开启或关闭alpha佩戴面具文字。",
        ["Overkill-Restoration-StupidtyNameLabelsTitleID"] = "alpha姓名标签",
        ["Overkill-Restoration-StupidtyNameLabelsDescID"] = "开启或关闭alpha姓名标签。",
        ["Overkill-Restoration-StupidtyHintTitleID"] = "alpha提示框",
        ["Overkill-Restoration-StupidtyHintDescID"] = "开启或关闭alpha提示框。",
        ["Overkill-Restoration-StupidtyExtraOptionsButtonTitleID"] = "更多HUD选项",
        ["Overkill-Restoration-StupidtyExtraOptionsButtonDescID"] = "甚至更多选项！",
        ["Overkill-Restoration-StupidtyRealAmmoTitleID"] = "真实弹药数量",
        ["Overkill-Restoration-StupidtyRealAmmoDescID"] = "总弹药计数忽略当前武器中弹药。",
        ["Overkill-Restoration-StupidtyStealthOrigPosTitleID"] = "原版警觉度指示器位置",
        ["Overkill-Restoration-StupidtyStealthOrigPosDescID"] = "将警觉度指示器设置于原版位置。",
        ["Overkill-Restoration-StupidtyLowerBagTitleID"] = "降低背包弹出栏",
        ["Overkill-Restoration-StupidtyLowerBagDescID"] = "降低背起包时弹出框位置。",
        ["Overkill-Restoration-StupidtyAssaultStyleTitleID"] = "突击横幅风格",
        ["Overkill-Restoration-StupidtyAssaultStyleDescID"] = "允许您选择一种您想用的突击横幅风格。",
        ["Overkill-Restoration-StupidtyCasingTickerTitleID"] = "Alpha踩点类型",
        ["Overkill-Restoration-StupidtyCasingTickerDescID"] = "开启或关闭Alpha踩点类型（需要Alpha类型风格）。",
        ["Overkill-Restoration-StupidtyCustodyTitleID"] = "Alpha拘留",
        ["Overkill-Restoration-StupidtyCustodyDescID"] = "开启或关闭Alpha拘留面板。",
        ["Overkill-Restoration-StupidtyCrimenetTitleID"] = "Alpha CRIMENET (WIP)",
        ["Overkill-Restoration-StupidtyCrimenetDescID"] = "开启或关闭Alpha CRIMENET。",
        ["Overkill-Restoration-StupidtyProfileTitleID"] = "Alpha个人资料栏",
        ["Overkill-Restoration-StupidtyProfileDescID"] = "开启或关闭Alpha个人资料栏。",
        ["Overkill-Restoration-StupidtyNewsfeedTitleID"] = "Alpha新闻速览",
        ["Overkill-Restoration-StupidtyNewsfeedDescID"] = "开启或关闭Alpha新闻速览。",
        ["Overkill-Restoration-StupidtyUppercaseNamesTitleID"] = "姓名大写",
        ["Overkill-Restoration-StupidtyUppercaseNamesDescID"] = "开启或关闭姓名大写。",
        ["Overkill-Restoration-StupidtyPeerColorsTitleID"] = "Alpha同伴颜色",
        ["Overkill-Restoration-StupidtyPeerColorsDescID"] = "开启或关闭Alpha同伴颜色。",
        ["Overkill-Restoration-StupidtyPocoCrimenetAlignSortTitleID"] = "Poco对齐排序CRIMENET",
        ["Overkill-Restoration-StupidtyPocoCrimenetAlignSortDescID"] = "按照难度对齐排序CRIMENET。",
        ["Overkill-Restoration-StupidtyPocoCrimenetScaleTitleID"] = "Poco CRIMENET尺寸",
        ["Overkill-Restoration-StupidtyPocoCrimenetScaleDescID"] = "允许您设置CRIMENET尺寸。",
        ...
        ["Overkill-Restoration-StupidtyVoiceIconTitleID"] = "语音聊天图标",
        ["Overkill-Restoration-StupidtyVoiceIconDescID"] = "当玩家使用游戏内语音聊天时显示。",
        ...
        ["Overkill-Restoration-StupidtyDodgeDisplayTitleID"] = "闪避条显示方式",
        ["Overkill-Restoration-StupidtyDodgeDisplayDescID"] = "选择显示闪避条的最大上限为多少。重启劫案以应用更改。",
        ["dd_scale"] = "150 -闪避等级",
        ["dd_150"] = "150",
        ["dd_100"] = "100",
        ...
        ["Overkill-Restoration-StupidtyPDTHChallengesTitleID"] = "显示 收获日：掠夺 挑战",
        ["Overkill-Restoration-StupidtyPDTHChallengesDescID"] = "设置 收获日：掠夺 挑战在菜单与HUD上是否可见",

        ["Overkill-Restoration-StupidtyRaidLockPickingTitleID"] = "撬锁调整",
        ["Overkill-Restoration-StupidtyRaidLockPickingDescID"] = "模组应该调整撬锁？这会改变与撬锁有关的游戏玩法",
        ["Overkill-Restoration-StupidtyRaidLockPickingVOTitleID"] = "播放语音",
        ["Overkill-Restoration-StupidtyRaidLockPickingVODescID"] = "模组应该在撬锁时播放语音？",
        ["hud_legend_lockpicking_interact"] = "$BTN_INTERACT撬锁",
        ["hud_legend_persuade_interact"] = "$BTN_INTERACT说服",
        ["hud_legend_exit"] = "$BTN_CANCEL退出",
        ["Overkill-Restoration-StupidtyArmorFixTitleID"] = "护甲闪烁修复",
        ["Overkill-Restoration-StupidtyArmorFixDescID"] = "开启或关闭护甲闪烁修复。",
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
    LocalizationManager:add_localized_strings({
        ...
        ["loading_fluff_res_8"] = "恢复MOD原名Overkill-Restoration-Stupidty，时常被国内玩家戏称为\"PDTH2.0\"、\"PAYDAY2.5\"和\"收获日2重制版\"。",
