...
Hooks:Add("LocalizationManagerPostInit", "ResMod_english_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["Overkill-Restoration-StupidtyOptionsButtonTitleID"] = "레스토레이션 모드 옵션",
		["Overkill-Restoration-StupidtyOptionsButtonDescID"] = "레스토레이션 모드의 옵션을 봅니다.",
		["Overkill-Restoration-StupidtyHUDOptionsButtonTitleID"] = "레스토레이션 HUD & UI 옵션",
		["Overkill-Restoration-StupidtyHUDOptionsButtonDescID"] = "레스토레이션의 HUD & UI 옵션을 봅니다.",
		["Overkill-Restoration-StupidtyOTHEROptionsButtonTitleID"] = "추가 레스토레이션 모드 옵션",
		["Overkill-Restoration-StupidtyOTHEROptionsButtonDescID"] = "추가 레스토레이션 모드 옵션을 봅니다.",
		["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonTitleID"] = "++ 무기 조작성 옵션 ++",
		["Overkill-Restoration-StupidtyWeaponHandlingOptionsButtonDescID"] = "무기 조작성에 관한 추가 옵션을 봅니다.",
		["Overkill-Restoration-StupidtyUIOptionsButtonTitleID"] = "알파 UI",
		["Overkill-Restoration-StupidtyUIOptionsButtonDescID"] = "알파 UI 옵션을 봅니다.",
		["Overkill-Restoration-StupidtyTimeOfDayTitleID"] = "새로운 + 무작위 시간대",
		["Overkill-Restoration-StupidtyTimeOfDayDescID"] = "특정 하이스트의 시간대를 설정합니다.",

		["Overkill-Restoration-StupidtyOtherModsTitleID"] = "===다른 모드 옵션===",
		["Overkill-Restoration-StupidtyOtherModsDescID"] = "다른 모드에 대한 추가 옵션을 봅니다.",
			["Overkill-Restoration-StupidtyAdVMovResOptOptionsButtonTitleID"] = "\"Advanced Movement Standalone\" 옵션",
			["Overkill-Restoration-StupidtyAdVMovResOptOptionsButtonDescID"] = "Solo Queue Pixy의 \"Advanced Movement Standalone\" 모드에 대한 추가 옵션을 봅니다.",

		["Overkill-Restoration-StupidtyEnv_BanksTitleID"] = "뱅크 지점",
		["Overkill-Restoration-StupidtyEnv_BanksDescID"] = "뱅크 지점의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_RVD1TitleID"] = "저수지의 개들 1일차",
		["Overkill-Restoration-StupidtyEnv_RVD1DescID"] = "저수지의 개들 1일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_RVD2TitleID"] = "저수지의 개들 2일차",
		["Overkill-Restoration-StupidtyEnv_RVD2DescID"] = "저수지의 개들 2일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_FSD1TitleID"] = "파이어스타터 1일차",
		["Overkill-Restoration-StupidtyEnv_FSD1DescID"] = "파이어스타터 1일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_PBR2TitleID"] = "버스 오브 스카이",
		["Overkill-Restoration-StupidtyEnv_PBR2DescID"] = "버스 오브 스카이의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_CJ2TitleID"] = "더 밤: 항구",
		["Overkill-Restoration-StupidtyEnv_CJ2DescID"] = "더 밤: 항구의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_UnderPassTitleID"] = "트랜스포트: 지하도",
		["Overkill-Restoration-StupidtyEnv_UnderPassDescID"] = "트랜스포트: 지하도 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_MallCrasherTitleID"] = "몰크래셔",
		["Overkill-Restoration-StupidtyEnv_MallCrasherDescID"] = "몰크래셔의 환경을선택합니다.",
		["Overkill-Restoration-StupidtyEnv_Mia_1TitleID"] = "핫라인 마이애미 1일차",
		["Overkill-Restoration-StupidtyEnv_Mia_1DescID"] = "핫라인 마이애미 1일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_FSD3TitleID"] = "파이어스타터 3일차",
		["Overkill-Restoration-StupidtyEnv_FSD3DescID"] = "파이어스타터 3일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_WDD1NTitleID"] = "와치독스 1일차 (밤)",
		["Overkill-Restoration-StupidtyEnv_WDD1NDescID"] = "와치독스 1일차 (밤)의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_WDD1DTitleID"] = "와치독스 1일차 (낮)",
		["Overkill-Restoration-StupidtyEnv_WDD1DDescID"] = "와치독스 1일차 (낮)의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_WDD2DTitleID"] = "와치독스 2일차 (낮)",
		["Overkill-Restoration-StupidtyEnv_WDD2DDescID"] = "와치독스 2일차 (낮)의 환경을선택합니다.",
		["Overkill-Restoration-StupidtyEnv_Alex3TitleID"] = "랫츠 3일차",
		["Overkill-Restoration-StupidtyEnv_Alex3DescID"] = "랫츠 3일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_BigTitleID"] = "빅 뱅크",
		["Overkill-Restoration-StupidtyEnv_BigDescID"] = "빅 뱅크의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_FSTitleID"] = "포 스토어",
		["Overkill-Restoration-StupidtyEnv_FSDescID"] = "포 스토어의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_UkraTitleID"] = "우크라이니안 잡",
		["Overkill-Restoration-StupidtyEnv_UkraDescID"] = "우크라이니안 잡의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_KosugiTitleID"] = "섀도 레이드",
		["Overkill-Restoration-StupidtyEnv_KosugiDescID"] = "섀도 레이드의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_PetaTitleID"] = "고트 시뮬레이터 1일차",
		["Overkill-Restoration-StupidtyEnv_PetaDescID"] = "고트 시뮬레이터 1일차의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyEnv_FRIENDTitleID"] = "스카페이스 맨션",
		["Overkill-Restoration-StupidtyEnv_FRIENDDescID"] = "스카페이스 맨션의 환경을 선택합니다.",
		["Overkill-Restoration-StupidtyINFOHUDOptionsButtonTitleID"] = "버프 트래커",
		["Overkill-Restoration-StupidtyINFOHUDOptionsButtonDescID"] = "화면 왼쪽에 활성화된 스킬에 대한 정보를 반영하는 아이콘을 표시합니다. 버프 트래커는 알파 UI를 활성화할 필요가 없습니다.",
		["Overkill-Restoration-StupidtyInfo_HudTitleID"] = "버프 트래커 활성화",
		["Overkill-Restoration-StupidtyInfo_HudDescID"] = "버프 트래커 UI 전부를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_SizeTitleID"] = "아이콘 크기",
		["Overkill-Restoration-StupidtyInfo_SizeDescID"] = "버프 트래커의 아이콘 크기를 설정합니다.",
		["Overkill-Restoration-StupidtyInfo_CountTitleID"] = "행 개수",
		["Overkill-Restoration-StupidtyInfo_CountDescID"] = "새 열을 추가하기 전에 버프 트래커가 표시하는 행의 수를 설정합니다.",
		["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadTitleID"] = "공격적 재장전",
		["Overkill-Restoration-StupidtyInfo_single_shot_fast_reloadDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_ammo_efficiencyTitleID"] = "효율적인 탄약 활용",
		["Overkill-Restoration-StupidtyInfo_ammo_efficiencyDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedTitleID"] = "피의 갈증",
		["Overkill-Restoration-StupidtyInfo_bloodthirst_reload_speedDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_bullet_stormTitleID"] = "탄환 폭풍",
		["Overkill-Restoration-StupidtyInfo_bullet_stormDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_revive_damage_reductionTitleID"] = "의무병",
		["Overkill-Restoration-StupidtyInfo_revive_damage_reductionDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_desperadoTitleID"] = "데스페라도",
		["Overkill-Restoration-StupidtyInfo_desperadoDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_grinderTitleID"] = "히스타민 (그라인더)",
		["Overkill-Restoration-StupidtyInfo_grinderDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_infiltratorTitleID"] = "체력 흡수 (인틸트레이터)",
		["Overkill-Restoration-StupidtyInfo_infiltratorDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_sociopathTitleID"] = "긴장 및 클린 히트 (소시오패스)",
		["Overkill-Restoration-StupidtyInfo_sociopathDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_body_expertiseTitleID"] = "뿌리고 기도",
		["Overkill-Restoration-StupidtyInfo_body_expertiseDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_long_dis_reviveTitleID"] = "인스파이어",
		["Overkill-Restoration-StupidtyInfo_long_dis_reviveDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_messiahTitleID"] = "메시아",
		["Overkill-Restoration-StupidtyInfo_messiahDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierTitleID"] = "오버킬",
		["Overkill-Restoration-StupidtyInfo_overkill_damage_multiplierDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_revived_damage_reductionTitleID"] = "진통제",
		["Overkill-Restoration-StupidtyInfo_revived_damage_reductionDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionTitleID"] = "응급 치료",
		["Overkill-Restoration-StupidtyInfo_first_aid_damage_reductionDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_rogueTitleID"] = "킬러 인스팅트 (로그)",
		["Overkill-Restoration-StupidtyInfo_rogueDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_increased_movement_speedTitleID"] = "죽음으로부터의 도주",
		["Overkill-Restoration-StupidtyInfo_increased_movement_speedDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multTitleID"] = "명사수",
		["Overkill-Restoration-StupidtyInfo_headshot_fire_rate_multDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_trigger_happyTitleID"] = "난사광",
		["Overkill-Restoration-StupidtyInfo_trigger_happyDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedTitleID"] = "언더독",
		["Overkill-Restoration-StupidtyInfo_dmg_multiplier_outnumberedDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_unseen_strikeTitleID"] = "암습",
		["Overkill-Restoration-StupidtyInfo_unseen_strikeDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_survive_one_hitTitleID"] = "오니 문신 (야쿠자)",
		["Overkill-Restoration-StupidtyInfo_survive_one_hitDescID"] = "이 특정 스킬의 트래커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenTitleID"] = "의료 가방 체력 회복",
		["Overkill-Restoration-StupidtyInfo_doctor_bag_health_regenDescID"] = "의료 가방 체력 회복 트래커를 활성화하거나 비활성화합니다.",

		--EXTRA OPTIONS
		["Overkill-Restoration-StupidtyAltLastDownColorTitleID"] = "대체 마지막 다운 색 보정",
		["Overkill-Restoration-StupidtyAltLastDownColorDescID"] = "마지막 다운의 색 보정을 color_sin_classic으로 전환합니다.",
		["Overkill-Restoration-StupidtyNoBleedoutTiltTitleID"] = "블리드아웃 카메라 기울기 비활성화",
		["Overkill-Restoration-StupidtyNoBleedoutTiltDescID"] = "블리드아웃 중에 발생하는 카메라 기울기를 비활성화합니다.",
		["Overkill-Restoration-StupidtyGOTTAGETAGRIPTitleID"] = "모든 포어그립 숨기기",
		["Overkill-Restoration-StupidtyGOTTAGETAGRIPDescID"] = "메뉴에 나오는 \"vertical_grip\" 유형의 *모든* 부착물을 숨깁니다. 무기에 이미 장착된 부착물은 영향을 받지 않습니다. 재시작이 필요합니다.",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTitleID"] = "슈퍼 시리얼 무기",
		["Overkill-Restoration-StupidtyGCGPYPMMSACDescID"] = "스타 워즈 블래스터 메커니즘을 비활성화합니다. 재시작이 필요합니다.",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTextTitleID"] = "슈퍼 시리얼 텍스트",
		["Overkill-Restoration-StupidtyGCGPYPMMSACTextDescID"] = "텍스트 기반의 이스터 에그가 랜덤으로 나타나는 것을 비활성화합니다. 재시작이 필요합니다.",
		["Overkill-Restoration-StupidtyForceEggsOptionsButtonTitleID"] = "강제 이스터 에그 텍스트",
		["Overkill-Restoration-StupidtyForceEggsOptionsButtonDescID"] = "개별 이스터 에그 텍스트를 강제로 활성화합니다. 활성화 되었을때 \"슈퍼 시리얼 텍스트\"도 활성화되어 있으면 해당 옵션을 무시합니다.\n무엇이든 전환하면 재시작이 필요합니다.",
			...
			["Overkill-Restoration-StupidtyBigManDescID"] = "다른 이스터 에그 텍스트를 활성화합니다.  ",
		["Overkill-Restoration-StupidtySevenHoldTitleID"] = "상호작용 토글 (Press2Hold)",
		["Overkill-Restoration-StupidtySevenHoldDescID"] = "상호작용 키가 토글 역할을 하는지 여부를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtySevenHoldDeployCancelTitleID"] = "배치물 취소 상호작용",
		["Overkill-Restoration-StupidtySevenHoldDeployCancelDescID"] = "배치물 키가 상호작용을 취소하는 데 토클이 사용되는지 여부를 활성화하거나 비활성화합니다. 상호작용 토글을 활성화해야 효과가 있습니다.",
		["Overkill-Restoration-StupidtyClassicMoviesTitleID"] = "클래식 로드아웃 배경",
		["Overkill-Restoration-StupidtyClassicMoviesDescID"] = "클래식 하이스트를 플레이할 때 PD:TH 로드아웃 배경을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyWpnCatTitleID"] = "구매 메뉴 탭 정렬",
		["Overkill-Restoration-StupidtyWpnCatDescID"] = "블랙마켓 메뉴에서 무기를 구매할 때 사용되는 무기 그룹화 방식을 변경합니다. 재시작이 필요합니다.",
			["base_wpn_cat"] = "스킬 기반",
			["sub_wpn_cat"] = "하위 카테고리 및 피해량 티어",

		["Overkill-Restoration-StupidtyWepNamesTitleID"] = "무기 (재)명칭",
		["Overkill-Restoration-StupidtyWepNamesDescID"] = "무기와 부착물의 이름 스타일을 변경합니다. 재시작이 필요합니다.",
		...
		["Overkill-Restoration-StupidtyDisableAdvMovTFTitleID"] = "벽 달리기/점프 비활성화",
		["Overkill-Restoration-StupidtyDisableAdvMovTFDescID"] = "Advanced Movement의 벽 달리기와 점프 기능을 비활성화합니다.",
		["Overkill-Restoration-StupidtyAdvMovMeleeTitleID"] = "근접 공격 기능",
		["Overkill-Restoration-StupidtyAdvMovMeleeDescID"] = "Advanced Movement의 점프, 슬라이드, 대시, 달리기 킥 기능을 바꿉니다.",
			["resmod_advmov_melee_on"] = "기본",
			["resmod_advmov_melee_loud_only"] = "라우드에서만",
			["resmod_advmov_melee_off"] = "비활성화",

		--WEAPON HANDLING
		["Overkill-Restoration-StupidtyStaticAimTitleID"] = "정조준 도중 무기 움직임 없음",
		["Overkill-Restoration-StupidtyStaticAimDescID"] = "조준 중 장식 흔들림과 드리프트를 활성화 혹은 비활성화합니다. 활성화하면 \"뷰모델 움직임\" 설정을 재정의합니다. 재시작이 필요합니다. 경고: 체크하지 않은 상태면 일부 광학 조준기를 사용할 수 없게 될 수 있습니다.",
		["Overkill-Restoration-StupidtyBigScopeOffsetTitleID"] = "\"큰 조준기\" 뷰모델 오프셋",
		["Overkill-Restoration-StupidtyBigScopeOffsetDescID"] = "큰 광학 조준기를 사용할 때 시각적 방해를 줄이기 위해 지향 사격 뷰모델을 약간 기울이고 오른쪽으로 이동합니다.",
		["Overkill-Restoration-StupidtyViewmodelMovementTitleID"] = "뷰모델 움직임",
		["Overkill-Restoration-StupidtyViewmodelMovementDescID"] = "주변을 둘러볼 때 화면에서 무기의 뷰모델이 어떻게 움직이는지 선택합니다. 정조준 움직임은 \"ADS 중 무기 움직임 없음\" 설정이 활성화된 경우 재정의됩니다. 재시작이 필요합니다.",
			["vm_vanilla"] = "바닐라 동작",
			["vm_drag"] = "무기가 뒤로 끌림",
			["vm_lead"] = "무기가 앞서 나감",
			["vm_static"] = "정적 (움직임 없음)",
		["Overkill-Restoration-StupidtyCarpalTunnelTitleID"] = "반동 자동 복구",
		["Overkill-Restoration-StupidtyCarpalTunnelDescID"] = "반동 자동 회복 메커니즘이 어떻게 작동하는지 선택합니다. 활성화된 버전은 다르게 균형을 이룹니다.",
			["rr_off"] = "비활성화",
			["rr_per_weapon"] = "무기에 따라",
			["rr_full"] = "모두",
		["Overkill-Restoration-StupidtyAutoDMRsTitleID"] = "지정사수 소총 자동 사격으로 전환",
		["Overkill-Restoration-StupidtyAutoDMRsDescID"] = "단발 및 자동 사격 모드가 있는 모든 지정사수 소총을 자동 사격 모드로 전환할지 여부를 설정합니다.",
		["Overkill-Restoration-StupidtyWpnFireDescopeTitleID"] = "특정 무기의 디스코프 허용",
		["Overkill-Restoration-StupidtyWpnFireDescopeDescID"] = "일부 무기가 사격 시 디스코프를 해제할 수 있는지 여부를 설정합니다. 주의: 디스코프는 클리핑을 줄이는 데 사용됩니다. 일부 조준기는 비활성화하면 클리핑될 수 있습니다. 디스코프를 메커니즘으로 언급된 무기는 해당 설정이 무시합니다.",
		["Overkill-Restoration-StupidtySprintCancelTitleID"] = "위기모면 에이스 효과의 달리기 재장전 취소",
		["Overkill-Restoration-StupidtySprintCancelDescID"] = "\"위기모면\" 스킬을 에이스까지 가지고 있을때 달리기를 *시작*하면 진행 중인 재장전이 취소되는지 여부를 설정합니다. 전력 질주 도중에 재장전하는 것은 영향을 받지 않습니다.",
		["Overkill-Restoration-StupidtyQueuedShootingTitleID"] = "발사 선입력 버퍼",
		["Overkill-Restoration-StupidtyQueuedShootingDescID"] = "단발 및 오버샘플링(무기가 발사할 수 있는 속도보다 빠르게 입력을 전송)을 지원하는 무기의 발사 선입력 버퍼링을 활성화 혹은 비활성화하여 합니다.\n이 기능을 활성화하면 오버킬 버전의 입력 버퍼링이 비활성화됩니다.",
		["Overkill-Restoration-StupidtyQueuedShootingWindowTitleID"] = "단발 버퍼 감도",
		["Overkill-Restoration-StupidtyQueuedShootingWindowDescID"] = "무기의 발사 선입력의 %에 따라 발사 입력이 버퍼링되는 시간대를 결정합니다. 값이 높을수록 버퍼가 더 빨리 생성됩니다.",
		["Overkill-Restoration-StupidtyQueuedShootingExcludeTitleID"] = "단발 선입력 버퍼의 발사 속도 제한",
		["Overkill-Restoration-StupidtyQueuedShootingExcludeDescID"] = "이 옵션에서 설정한 발사 속도(RPM) *이상으로* 발사되는 무기의 발사 선입력 버퍼링을 제한합니다.",
		["Overkill-Restoration-StupidtyQueuedShootingMidBurstTitleID"] = "중간 점사 입력 버퍼",
		["Overkill-Restoration-StupidtyQueuedShootingMidBurstDescID"] = "점사 *도중*에 이루어지는 발사 선입력을 설정합니다.",
		["Overkill-Restoration-StupidtyQueuedShootingBurstExcludeTitleID"] = "중간 점사 선입력 버퍼 제한",
		["Overkill-Restoration-StupidtyQueuedShootingBurstExcludeDescID"] = "이 옵션에서 설정한 값(ms) *아래*의 버스트 지연 시간을 갖는 무기에 대한 버스트 *중*에 이루어지는 사격 입력 버퍼링을 제한합니다.",
		["Overkill-Restoration-StupidtyNoADSRecoilAnimsTitleID"] = "정조준 반동 애니메이션 없음",
		["Overkill-Restoration-StupidtyNoADSRecoilAnimsDescID"] = "정조준 반동 애니메이션을 활성화 혹은 비활성화합니다. 일부 무기는 이 옵션의 영향을 받지 않습니다(예: 수동 작동 총, 활, 화염 방사기)",
		["Overkill-Restoration-StupidtyNoSwapOnReviveTitleID"] = "소생 시 강제 무기 교체 없음",
		["Overkill-Restoration-StupidtyNoSwapOnReviveDescID"] = "불사 에이스 스킬이 없어도 주 무기로 쓰러졌을 때 소생 시 강제 무기 교체를 비활성화합니다.",
		["Overkill-Restoration-StupidtyManualReloadsTitleID"] = "수동 재장전",
		["Overkill-Restoration-StupidtyManualReloadsDescID"] = "탄창이 비어 있을 때 자동 재장전을 비활성화합니다. 주의: 해당 설정은 \"재장전 마라톤\" 뮤테이터가 활성화되어 있으면 무시됩니다.",
		["Overkill-Restoration-StupidtySecondSightSprintTitleID"] = "달리기 버튼 누르는 동안 보조 조준기 전환",
		["Overkill-Restoration-StupidtySecondSightSprintDescID"] = "정조준 중에 보조 조준기를 켜고 끄려면 가젯 버튼 대신 달리기 버튼을 사용합니다.\n활성화된 가젯은 U232 이전과 마찬가지로 전환이 가능하지만 정조준 중에는 달리기를 할 수 없습니다.",
		["Overkill-Restoration-StupidtyADSTransitionStyleTitleID"] = "정조준 스타일",
		["Overkill-Restoration-StupidtyADSTransitionStyleDescID"] = "조준기를 조준하는 전환 스타일을 변경합니다.",
			["vanilla_on_rails"] = "기본/온레일",
			["kf_mw_style"] = "킬플1/콜옵 스타일",
			["tilt_in"] = "기울어짐",
		["Overkill-Restoration-StupidtyAimDeploysBipodTitleID"] = "정조준 삼각대 배치",
		["Overkill-Restoration-StupidtyAimDeploysBipodDescID"] = "알맞는 표면 위로 정조준 할 때 삼각대가 자동으로 펼치는지에 대해 활성화 혹은 비활성화합니다.",
		["Overkill-Restoration-StupidtyMoveCancelBipodTitleID"] = "이동 시 삼각대 분리",
		["Overkill-Restoration-StupidtyMoveCancelBipodDescID"] = "기본적인 이동이 삼각대를 분리를 입력하는지에 대해 활성화 혹은 비활성화합니다.",
		["Overkill-Restoration-StupidtySeparateBowADSTitleID"] = "별도 활 조준",
		["Overkill-Restoration-StupidtySeparateBowADSDescID"] = "화살을 당낄 때 활의 강제 조준을 비활성화합니다. 활성화된 경우, 재장전 키는 당겨진 화살을 내리는 데 사용됩니다.",
		["Overkill-Restoration-StupidtyPerPelletShotgunsTitleID"] = "펠릿당 산탄총 대미지 (WIP)",
		["Overkill-Restoration-StupidtyPerPelletShotgunsDescID"] = "산탄총 피해는 표준 \"펠릿 1개 = 최대 피해량, 헤드샷 우선\"과 달리 펠릿당으로 계산합니다. 낮은 일관성을 보완하기 위해 슬러그를 제외한 산탄총의 대미지가 증가합니다. 재시작이 필요합니다.",
		...
		["Overkill-Restoration-StupidtyPaintingsTitleID"] = "미사용된 아트 갤러리 그림",
		["Overkill-Restoration-StupidtyPaintingsDescID"] = "사용하지 않는 그림이 아트 갤러리에 생성되는 기능을 활성화 또는 비활성화합니다. 호스트만 적용됩니다.",
		["Overkill-Restoration-StupidtyMainHUDTitleID"] = "알파 HUD 켜기 혹은 끄기",
		["Overkill-Restoration-StupidtyMainHUDDescID"] = "알파 HUD를 전체적으로 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyWaypointsTitleID"] = "알파 웨이포인트",
		["Overkill-Restoration-StupidtyWaypointsDescID"] = "알파 웨이포인트를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyAssaultPanelTitleID"] = "알파 어썰트 테이프",
		["Overkill-Restoration-StupidtyAssaultPanelDescID"] = "알파 어썰트 테이프를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyAltAssaultTitleID"] = "초기 어썰트 공격 표시기",
		["Overkill-Restoration-StupidtyAltAssaultDescID"] = "초기 어썰트 공격 표시기를 활성화하거나 비활성화하고 테이프를 대체합니다.",
		["Overkill-Restoration-StupidtyObjectivesPanelTitleID"] = "알파 목표 패널",
		["Overkill-Restoration-StupidtyObjectivesPanelDescID"] = "알파 목표 패널을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyPresenterTitleID"] = "알파 프리젠터",
		["Overkill-Restoration-StupidtyPresenterDescID"] = "전리품 확보하거나 목표 알림 다일로그에 사용되는 알파 프리젠터를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyInteractionTitleID"] = "알파 상호 작용 미터",
		["Overkill-Restoration-StupidtyInteractionDescID"] = "알파 상호 작용 미터를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyStealthTitleID"] = "알파 스텔스 미터",
		["Overkill-Restoration-StupidtyStealthDescID"] = "알파 스텔스 미터를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyDownTitleID"] = "알파 다운 타이머",
		["Overkill-Restoration-StupidtyDownDescID"] = "알파 다운 타이머를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyBagTitleID"] = "알파 가방 패널",
		["Overkill-Restoration-StupidtyBagDescID"] = "알파 가방 패널을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyHostageTitleID"] = "인질 패널 숨기기",
		["Overkill-Restoration-StupidtyHostageDescID"] = "활성화하면 어썰트 테이프 또는 초기 알파 표시기가 켜져 있는 경우 돌격이 시작될 때 인질 패널을 숨깁니다.",
		["Overkill-Restoration-StupidtyDifficultyMarkersTitleID"] = "출시 전 난이도 마커",
		["Overkill-Restoration-StupidtyDifficultyMarkersDescID"] = "출시 전 난이도 마커를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyStaminaIndicatorTitleID"] = "디버그 스태미나 표시기",
		["Overkill-Restoration-StupidtyStaminaIndicatorDescID"] = "디버그 스태미나 표시기를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyBlackScreenTitleID"] = "레스토레이션 블랙 스크린",
		["Overkill-Restoration-StupidtyBlackScreenDescID"] = "레스토레이션 블랙 스크린을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyLoadoutsTitleID"] = "알파 로드아웃",
		["Overkill-Restoration-StupidtyLoadoutsDescID"] = "알파 로드아웃 화면을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyDistrictTitleID"] = "CRIME.NET 구역 설명",
		["Overkill-Restoration-StupidtyDistrictDescID"] = "CRIME.NET에 구역 설명을 활성화하거나 비활성화합니다. 게임 플레이에는 영향을 주지 않습니다.",
		["Overkill-Restoration-StupidtySCOptionsButtonTitleID"] = "레스토레이션 오버홀 옵션",
		["Overkill-Restoration-StupidtySCOptionsButtonDescID"] = "레스토레이션 오버홀 옵션",
		["Overkill-Restoration-StupidtySCTitleID"] = "완전한 오버홀 (디버그)",
		["Overkill-Restoration-StupidtySCDescID"] = "레스토레잇녀의 완전한 게임 오버홀을 활성화 또는 비활성화합니다. 이 옵션을 토글하면 세이브 파일 손상을 방지하기 위해 게임이 자동으로 종료됩니다.",
		["Overkill-Restoration-StupidtyHolidayTitleID"] = "홀리데이 효과",
		["Overkill-Restoration-StupidtyHolidayDescID"] = "오버홀의 홀리데이 효과를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyCloakerTurnTitleID"] = "클로커 킥 카메라 턴",
		["Overkill-Restoration-StupidtyCloakerTurnDescID"] = "클로커가 킥을 시전할 때 바닐라의 클로커 카메라 회전 기능을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyDisableMutatorColorsTitleID"] = "뮤테이터 어썰트 배너 색상 비활성화",
		["Overkill-Restoration-StupidtyDisableMutatorColorsDescID"] = "뮤테이터를 사용할 때 어썰트 배너의 색상 변경을 비활성화합니다(바닐라 HUD에만 해당).",
		...
		["Overkill-Restoration-StupidtyRestoreHitFlashTitleID"] = "히트 플래시 복원",
		["Overkill-Restoration-StupidtyRestoreHitFlashDescID"] = "대미지를 입었을 때 복원된 히트 플래시를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyBotsNoDropTitleID"] = "봇 전리품 가방 드롭 비활성화",
		["Overkill-Restoration-StupidtyBotsNoDropDescID"] = "봇이 전리품 가방을 떨어뜨리는 것을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyNotifyTitleID"] = "기능 알림",
		["Overkill-Restoration-StupidtyNotifyDescID"] = "이 기능에 대한 알림을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyPauseTitleID"] = "알파 일시 정지 메뉴",
		["Overkill-Restoration-StupidtyPauseDescID"] = "알파 일시 정지 메뉴를 활성화하거나 비활성화합니다.",
		...
		["Overkill-Restoration-StupidtyColorOption"] = "이 HUD 요소의 색상을 원하는 대로 변경합니다.",
		["Overkill-Restoration-StupidtyColorsOptionsButtonTitleID"] = "색상 설정",
		["Overkill-Restoration-StupidtyColorsOptionsButtonDescID"] = "많은 HUD 개체의 색상을 변경합니다.",
		["Overkill-Restoration-StupidtyObjectivesBGTitleID"] = "목표 배경",
		["Overkill-Restoration-StupidtyObjectivesFGTitleID"] = "목표 전경",
		["Overkill-Restoration-StupidtyAssaultBGTitleID"] = "어썰트 배경",
		["Overkill-Restoration-StupidtyAssaultFGTitleID"] = "어썰트 전경",
		["Overkill-Restoration-StupidtyNoReturnTitleID"] = "돌아갈 수 없는 지점 텍스트",
		["Overkill-Restoration-StupidtyTimerTextTitleID"] = "하이스트 타이머 텍스트",
		["Overkill-Restoration-StupidtyAssaultEndlessBGTitleID"] = "캡틴 어썰트 배경",
		["Overkill-Restoration-StupidtyAssaultSurvivedBGTitleID"] = "생존한 어썰트 배경",
		["Overkill-Restoration-StupidtyStaminaTitleID"] = "스태미나",
		["Overkill-Restoration-StupidtyStaminaThresholdTitleID"] = "스태미나 한계점",
		["Overkill-Restoration-StupidtyBagBitmapTitleID"] = "가방",
		["Overkill-Restoration-StupidtyBagTextTitleID"] = "가방 텍스트",
		["Overkill-Restoration-StupidtyNoReturnTextTitleID"] = "돌아갈 수 없는 지점 텍스트",
		["Overkill-Restoration-StupidtyHostagesTextTitleID"] = "인질 텍스트",
		["Overkill-Restoration-StupidtyHintTextTitleID"] = "힌트 텍스트",
		["Overkill-Restoration-StupidtyMaskOnTextTitleID"] = "마스크 끼기 텍스트",
		["Overkill-Restoration-StupidtyDownsThreePlusTitleID"] = "다운 카운터 (다운 3개 이상 남음)",
		["Overkill-Restoration-StupidtyDownsTwoTitleID"] = "다운 카운터 (다운 2개 남음)",
		["Overkill-Restoration-StupidtyDownsOneTitleID"] = "다운 카운터 (다운 1개 남음)",
		["Overkill-Restoration-StupidtyDownsZeroTitleID"] = "다운 카운터 (다운 0개 남음)",
		["Overkill-Restoration-StupidtyStopAllBotsTitleID"] = "모든 봇 멈추기",
		["Overkill-Restoration-StupidtyStopAllBotsDescID"] = "봇 멈추는 키를 눌러 모든 봇을 멈추게합니다.",
		["Overkill-Restoration-StupidtyPONRTrackTitleID"] = "돌아갈 수 없는 지점 음악",
		["Overkill-Restoration-StupidtyPONRTrackDescID"] = "돌아올 수 없는 지점이 시작되면 프로 잡의 음악 트랙으로 변경합니다.",
		["Overkill-Restoration-StupidtyPONRTracksTitleID"] = "돌아갈 수 없는 지점 음악",
		["Overkill-Restoration-StupidtyPONRTracksDescID"] = "돌아올 수 없는 지점이 시작될 때 프로 잡의 음악 트랙을 선택합니다.",
		["Overkill-Restoration-StupidtyMusicShuffleTitleID"] = "음악 셔플",
		["Overkill-Restoration-StupidtyMusicShuffleDescID"] = "어썰트 종료 후 음악 트랙을 변경합니다.",
		...
		["Overkill-Restoration-StupidtyScaleTitleID"] = "HUD 크기 조정",
		["Overkill-Restoration-StupidtyScaleDescID"] = "HUD의 크기를 조정합니다. 재시작이 필요할 수 있습니다.",
		["Overkill-Restoration-StupidtySizeOnScreenTitleID"] = "화면의 HUD 크기",
		["Overkill-Restoration-StupidtySizeOnScreenDescID"] = "화면의 HUD 크기를 변경합니다. 재시작이 필요할 수 있습니다.",
		["Overkill-Restoration-StupidtyTeammateTitleID"] = "알파 팀원 패널",
		["Overkill-Restoration-StupidtyTeammateDescID"] = "당신과 당신 팀의 통계를 표시하는 알파 팀원 패널을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyHeistTimerTitleID"] = "알파 하이스트 타이머",
		["Overkill-Restoration-StupidtyHeistTimerDescID"] = "알파 하이스트 타이머를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyMaskOnTitleID"] = "알파 마스크 쓰기 텍스트",
		["Overkill-Restoration-StupidtyMaskOnDescID"] = "알파 마스크 쓰기 텍스트를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyNameLabelsTitleID"] = "알파 이름 라벨",
		["Overkill-Restoration-StupidtyNameLabelsDescID"] = "알파 이름 라벨을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyHintTitleID"] = "알파 힌트 패널",
		["Overkill-Restoration-StupidtyHintDescID"] = "알파 힌트 패널을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyExtraOptionsButtonTitleID"] = "많은 HUD 옵션",
		["Overkill-Restoration-StupidtyExtraOptionsButtonDescID"] = "더 많은 옵션이 있습니다!",
		["Overkill-Restoration-StupidtyRealAmmoTitleID"] = "실제 탄약량",
		["Overkill-Restoration-StupidtyRealAmmoDescID"] = "총 탄약량 카운터가 현재 무기에 장전된 탄약량을 무시합니다.",
		["Overkill-Restoration-StupidtyStealthOrigPosTitleID"] = "바닐라 감지 미터 위치",
		["Overkill-Restoration-StupidtyStealthOrigPosDescID"] = "바닐라와 같은 영역에 감지 미터를 놓습니다.",
		["Overkill-Restoration-StupidtyLowerBagTitleID"] = "집을 때 가방 팝업 낮춤",
		["Overkill-Restoration-StupidtyLowerBagDescID"] = "가방을 집을 때 나타나는 팝업을 낮춥니다.",
		["Overkill-Restoration-StupidtyAssaultStyleTitleID"] = "어썰트 패널 스타일",
		["Overkill-Restoration-StupidtyAssaultStyleDescID"] = "사용하려는 어썰트 패널의 스타일을 선택합니다.",
		["Overkill-Restoration-StupidtyCasingTickerTitleID"] = "알파 케이싱 테이프",
		["Overkill-Restoration-StupidtyCasingTickerDescID"] = "알파 케이싱 테이프를 활성화 또는 비활성화합니다 (알파 테이프 스타일 필요).",
		["Overkill-Restoration-StupidtyCustodyTitleID"] = "알파 구금",
		["Overkill-Restoration-StupidtyCustodyDescID"] = "알파 구금 패널을 활성화 또는 비활성화합니다.",
		["Overkill-Restoration-StupidtyCrimenetTitleID"] = "알파 CRIMENET (미완성)",
		["Overkill-Restoration-StupidtyCrimenetDescID"] = "알파 CRIMENET을 활성화 또는 비활성화합니다.",
		["Overkill-Restoration-StupidtyProfileTitleID"] = "알파 프로필 박스",
		["Overkill-Restoration-StupidtyProfileDescID"] = "알파 프로필 박스를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyNewsfeedTitleID"] = "알파 뉴스피드",
		["Overkill-Restoration-StupidtyNewsfeedDescID"] = "알파 뉴스피드를 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyUppercaseNamesTitleID"] = "대문자 이름",
		["Overkill-Restoration-StupidtyUppercaseNamesDescID"] = "대문자 이름을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyPeerColorsTitleID"] = "알파 피어 색상",
		["Overkill-Restoration-StupidtyPeerColorsDescID"] = "알파 피어 색상을 활성화하거나 비활성화합니다.",
		["Overkill-Restoration-StupidtyPocoCrimenetAlignSortTitleID"] = "Poco 중심 맞추기 및 CRIMENET 정렬",
		["Overkill-Restoration-StupidtyPocoCrimenetAlignSortDescID"] = "CRIMENET을 난이도별로 중심을 맞추고 정렬합니다.",
		["Overkill-Restoration-StupidtyPocoCrimenetScaleTitleID"] = "Poco CRIMENET 크기",
		["Overkill-Restoration-StupidtyPocoCrimenetScaleDescID"] = "CRIMENET의 크기를 설정합니다.",
		...
		["Overkill-Restoration-StupidtyVoiceIconTitleID"] = "음성 채팅 아이콘",
	    ["Overkill-Restoration-StupidtyVoiceIconDescID"] = "플레이어가 게임 내에서 음성 채팅을 사용할 때 표시합니다.",
		["Overkill-Restoration-StupidtyNewsFeedStyleTitleID"] = "알파 뉴스피드 스타일",
		["Overkill-Restoration-StupidtyNewsFeedStyleDescID"] = "뉴스피드와 뉴하이스트 박스를 둘 다 표시할지, 아니면 뉴스피드만 표시할지 선택합니다.",
		["alpha_assault"] = "초기 알파 코너",
		["beta_assault"] = "알파 테이프",
		["show_both"] = "기본",
		["show_classic_newsfeed"] = "클래식",

		["Overkill-Restoration-StupidtyDodgeDisplayTitleID"] = "회피 미터 판독 값",
		["Overkill-Restoration-StupidtyDodgeDisplayDescID"] = "회피 미터의 최대값 *표시*를 변경합니다. 재시작이 필요합니다.",
		["dd_scale"] = "150 - 회피율",
		["dd_150"] = "150",
		["dd_100"] = "100",
		...
		["Overkill-Restoration-StupidtyPDTHChallengesTitleID"] = "PDTH 챌린지 보기",
		["Overkill-Restoration-StupidtyPDTHChallengesDescID"] = "메뉴와 HUD에서 PDTH 챌린지의 가시성을 전환합니다.",

		["Overkill-Restoration-StupidtyRaidLockPickingTitleID"] = "수정된 락픽",
		["Overkill-Restoration-StupidtyRaidLockPickingDescID"] = "모드가 수정된 락픽을 사용하게 설정하겠습니까? 활성화 시 회전식 락픽 게임플레이로 변경됩니다.",
		["Overkill-Restoration-StupidtyRaidLockPickingVOTitleID"] = "음성 라인 재생",
		["Overkill-Restoration-StupidtyRaidLockPickingVODescID"] = "잠금 장치를 따고 있을때 모드가 음성 대사를 재생하게 설정하겠습니까?",
		...
		["Overkill-Restoration-StupidtyArmorFixTitleID"] = "방탄복 플래시 수정",
		["Overkill-Restoration-StupidtyArmorFixDescID"] = "방탄복 플래시 수정을 활성화하거나 비활성화합니다.",
