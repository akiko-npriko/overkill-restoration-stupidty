...
tweak_data.assault_rifle = {
	...
	tweak_data.crb = {
		...
		ads_moving_spread_mult = 1.15 / tweak_data.assault_rifle.ads_moving_spread_mult,
	...
	tweak_data.dmr_l = {
		...
		ads_moving_spread_mult = 1.35 / tweak_data.assault_rifle.ads_moving_spread_mult,
		shake_mul = 1.1
	}
	tweak_data.dmr_h = {
