...
function FPCameraPlayerBase:update(unit, t, dt)
	...
	--lweaponbetteranimmee = restoration.Options:GetValue("WEAPONS/WEAPONANIMS/BWAResmod")
	lweaponbetteranimmee = true
	if weaponbetteranimm then
		...
		local enable_bob = true
		local sway_style = true
